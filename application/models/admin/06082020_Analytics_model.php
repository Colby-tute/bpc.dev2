...
class Analytics_model extends CI_Model
{
    ...
    public function get_users_by_gender() {
    ...
    public function get_users_by_age() {
        ...
        $this->db->select("tbl_personal_details_dob, IFNULL(ROUND(DATEDIFF(CURRENT_DATE, STR_TO_DATE(tbl_personal_details_dob, '%Y-%m-%D'))/365),0) AS age, COUNT(*) as count");
        $this->db->group_by('age');
        $result = $this->db->get('tbl_personal_details')->result();
        return $result;
    }

    //Gets count of users by district
    public function get_users_by_district() {
        ...
        $result = $this->db->get('tbl_personal_details')->result_array();
        return $result;
    }

    //Gets count of users by town_village
    public function get_users_by_town_village() {
        ////SELECT `tbl_personal_details_town_village`,COUNT(*) FROM `tbl_personal_details` GROUP BY `tbl_personal_details_town_village`;
        $this->db->select('tbl_personal_details_town_village as town_village,COUNT(*) as count');
        $this->db->group_by('tbl_personal_details_town_village');
        $result = $this->db->get('tbl_personal_details')->result_array();
        return $result;
    }
    ...
    public function get_users_by_channels() {
        ...
        $this->db->group_by('tbl_personal_details_howdidyouknow');
        $result = $this->db->get('tbl_personal_details')->result_array();
        return $result;
    }
    ...
    public function get_users_by_browsers() {
        ...
        $this->db->select('
            CONCAT(UCASE(LEFT(tbl_login_history_login_from, 1)), SUBSTRING(lower(tbl_login_history_login_from), 2))
    ...
    public function get_smme_by_incubation_application_status() {
    ...
    public function get_smme_status_by_gender() {
