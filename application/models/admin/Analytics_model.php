...
public function getDemographicsReports($roleId =[],$statusId =[]){
   ...
   $query = $this->db->select(
    ...
    public function getactivityLogReport__old($roleId =[],$statusId =[]){
           $result= [];
           $query = $this->db->select(
            'u.tbl_users_user_uniqueid
            ,u.tbl_users_firstname,u.tbl_users_lastname
...
#########################
    public function getRegistrationsReport($roleid='',$fromdate='',$todate=''){
        $result=[];  
    ...
    public function getDemographicsReport($roleid='',$fromdate='',$todate=''){ 
                $query = $this->db->select(
                'distinct(u.tbl_users_user_uniqueid)
                ,u.tbl_users_firstname,u.tbl_users_lastname
                ,u.tbl_users_insertdate
    ...
    public function getincubationStatusReport($roleid='',$fromdate='',$todate=''){ 
                $query = $this->db->select(
                'distinct(u.tbl_users_user_uniqueid)
                ,u.tbl_users_firstname,u.tbl_users_lastname
                ,u.tbl_users_insertdate
    ...
    public function getchannelsReport($roleid='',$fromdate='',$todate=''){ 
                    $query = $this->db->select(
                    'distinct(u.tbl_users_user_uniqueid)
                    ,u.tbl_users_firstname,u.tbl_users_lastname
                    ,u.tbl_users_insertdate
    ...
    public function getsecurityReport($roleid='',$fromdate='',$todate=''){ 
        $query = $this->db->select(
        'u.tbl_users_user_uniqueid
        ,u.tbl_users_firstname,u.tbl_users_lastname
        ,u.tbl_users_insertdate
    ...
    public function getevaluationReport__new($roleid='',$fromdate='',$todate=''){ 
         $query = $this->db->select(
            'distinct(u.tbl_users_user_uniqueid)
            ,u.tbl_users_firstname,u.tbl_users_lastname
            ,u.tbl_users_insertdate
