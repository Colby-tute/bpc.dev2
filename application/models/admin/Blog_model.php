...
class Blog_model extends CI_Model
{
    ...
    public function sub_industries($id) {
        ...
        $this->db->where('tbl_basecenter_category_id',$id);
    ...
    public function select_blog_data($i) {

        $this->db->where('tbl_blog_id',$i);
    ...
    public function select_blog_images_data($id) {
        
        
        $this->db->where('tbl_blog_gallery_blog_id',$id);
        $query=$this->db->get('tbl_blog_gallery');
        $result=$query->result();
        $num_rows=$query->num_rows();
        $last_three_record=array_slice($result,-3,3,true);
        return $result;
    ...
    public function select_all_blog_view() {

        /*if($id != '')
        {
           $this->db->where("tbl_blog_admin_id ='".$id."'");
        }*/
        $this->db->order_by('tbl_blog_id', 'DESC');
        $query=$this->db->get('tbl_blog');
        $result=$query->result();
        return $result;
    ...
    public function update_master($user,$upd_id) {
            ...
            $this->db->where("tbl_blog_id ='".$upd_id."'");
            $this->db->update('tbl_blog', $user);
    ...
    public function image_delete($i)
    {
        /*print_r($i);
        print_r($data);exit;*/
        $this->db->where('tbl_blog_gallery_blog_id', $i);
        $this->db->delete('tbl_blog_gallery');
    }
    ...
    public function image_update($images,$id,$table,$field_name){
        //print_r($table);exit();
        $this->db->where($field_name,$id);
        $this->db->update($table, $images);
    }

    public function image_insert($images,$table){
        //print_r($table);exit();
       /* $this->db->where($field_name,$id);
        $this->db->update($table, $images);*/

        $this->db->insert($table, $images);
