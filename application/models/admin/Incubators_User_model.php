 ...
 */
class Incubators_User_model extends CI_Model
{
  ...
  public function update_master($user,$personal,$business,$smme_teams,$upd_id,$persona_id,$business_id) {
    ...
    public function did_delete_company_row($i)
    {
		...
		$tbl_users_user_uniqueid = $result->tbl_users_user_uniqueid;
		
		// Asssign MSME to Main MSME
		// application
		$dataSmme1['tbl_application_incubator_id'] = null;
		$this->db->where('tbl_application_incubator_id', $i);
        $query=$this->db->update('tbl_application', $dataSmme1);
		
        $dataSmme11['incubator_id'] = null;
        $this->db->where('incubator_id', $i);
        $query=$this->db->update('tbl_application_assignment', $dataSmme11);//check and delete
		//
		$dataSmme2['incubator_id'] = null;
		$this->db->where('incubator_id', $i);
        $query=$this->db->update('tbl_smme_event', $dataSmme2);
		...
		$dataSmme4['incubator_id'] = '0000';
		$this->db->where('incubator_id', $i);
        $query=$this->db->update('tbl_evaluate_bdsp_inc', $dataSmme4);
		
		$dataSmme41['inc_id'] = '0000';
		$this->db->where('inc_id', $i);
        $query=$this->db->update('tbl_evaluate_smme_inc', $dataSmme41);
		
		$dataSmme5['facility_booking_user_id'] = '0000';
		$this->db->where('facility_booking_user_id', $i);
        $query=$this->db->update('tbl_facility_bookings', $dataSmme5);
    ...
    public function select_business_docs2($id) {
...
$this->db->where("upload_for",0);
    ...
    public function select_all_role2()
    { 
        $query=$this->db->get('tbl_roles');
        $result=$query->result();
        $num_rows=$query->num_rows();
	...
	public function select_industry2() {
