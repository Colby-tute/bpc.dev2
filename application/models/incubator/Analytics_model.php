...
class Analytics_model extends CI_Model
{
    ...
    public function get_users_by_age($roleId =[],$statusId =[]) {
        ...
        $result = $this->db->get('tbl_personal_details pd')->result();
        return $result;
    }
    ...
    public function get_users_by_district($roleId =[],$statusId =[]) {
        ...
        $this->db->select('tbl_personal_details_district as district,COUNT(*) as count');
        $this->db->join('tbl_users as u', 'pd.tbl_personal_details_user_id = u.tbl_users_role_id', 'LEFT');

         if($roleId){
            $this->db->where_in('u.tbl_users_role_id',$roleId);
        }
        $this->db->group_by('tbl_personal_details_district');
        $result = $this->db->get('tbl_personal_details pd')->result_array();
        return $result;
    }
    ...
    public function get_users_by_channels($roleId =[],$statusId =[]) {
       ...
       // $this->db->select('tbl_personal_details_howdidyouknow as channel,  COUNT(*) as count');
    ...
    public function get_smme_by_incubation_application_status($roleId =[],$statusId =[]) {
        ...
        //$this->db->join('tbl_stages', 'tbl_users.tbl_users_role_id = 3 AND tbl_stages.id = tbl_users.tbl_users_status');
    ...
    public function get_smme_status_by_gender($roleId =[],$statusId =[]) {
        ...
        //$this->db->where('tbl_users_role_id=2  AND tbl_users_status IN (4,6)');
        if($roleId){
            $this->db->where_in('tbl_users_role_id',$roleId);
        }
        $this->db->group_by('tbl_users_gender');
...
##################kamlesh############
public function getRegistrationsReport_old($roleid=''){
   $result=[];  
...
public function getDemographicsReports__old($roleId =[],$statusId =[]){
   $result= [];
   ...
   $query = $this->db->select(
    ...
    public function getIncubationStatusReport__old($roleId =[],$statusId =[]){
       $result= [];
       $query = $this->db->select(
        'distinct(u.tbl_users_user_uniqueid)
        ,u.tbl_users_firstname,u.tbl_users_lastname
    ...
    public function getChannelsReport__old($roleId =[],$statusId =[]){
           $result= [];
           $query = $this->db->select(
            'distinct(u.tbl_users_user_uniqueid)
            ,u.tbl_users_firstname,u.tbl_users_lastname
     ...
     public function getsecurityReport_old($roleId =[],$statusId =[]){
           $result= [];
           $query = $this->db->select(
    ...
    public function getevaluationReport_old($roleid=[],$status=[]){
           $result= [];
    ...
    public function getIncubationProgressReport_old($roleid=[],$status=[]){
           $result= [];
    ...
    public function getInvestmentReport_old($roleid=[],$status=[]){
           $result= [];
    ...
    #####################11082020####
    public function getRegistrationsReport($uid='',$fromdate='',$todate=''){
        $result=[];  
        $query = $this->db->select('u.*,r.tbl_roles_id,r.tbl_roles_title,i.tbl_industry_name')
                ->from('tbl_application_assignment as tas')
                ->join('tbl_users as u', 'tas.smme_id = u.tbl_users_id', 'LEFT')
                ->join('tbl_roles as r', 'u.tbl_users_role_id = r.tbl_roles_id', 'LEFT')                
                ->join('tbl_business_details as bd', 'u.tbl_users_id=bd.tbl_business_details_user_id', 'LEFT')
                ->join('tbl_industry as i', 'i.tbl_industry_id=bd.tbl_business_details_industry', 'LEFT');

                if($uid){
                    $query->where('tas.incubator_id', $uid);
                }
                if(!empty($fromdate) && !empty($todate)){
                    $query->where("DATE_FORMAT(u.tbl_users_insertdate,'%Y-%m-%d') >=  '$fromdate'");
                    $query->where("DATE_FORMAT(u.tbl_users_insertdate,'%Y-%m-%d') <=  '$todate'");
                }
    }

    public function getDemographicsReport($uid='',$fromdate='',$todate=''){ 
                $query = $this->db->select(
                'distinct(u.tbl_users_user_uniqueid)
                ,u.tbl_users_firstname,u.tbl_users_lastname
                ,u.tbl_users_insertdate
    ...
    public function getincubationStatusReport($uid='',$fromdate='',$todate=''){ 
                $query = $this->db->select(
                'distinct(u.tbl_users_user_uniqueid)
                ,u.tbl_users_firstname,u.tbl_users_lastname
                ,u.tbl_users_insertdate
    ...
    public function getchannelsReport($uid='',$fromdate='',$todate=''){ 
                    $query = $this->db->select(
                    'distinct(u.tbl_users_user_uniqueid)
                    ,u.tbl_users_firstname,u.tbl_users_lastname
                    ,u.tbl_users_insertdate
    ...
    public function getsecurityReport($uid='',$fromdate='',$todate=''){ 
        $query = $this->db->select(
        'u.tbl_users_user_uniqueid
        ,u.tbl_users_firstname,u.tbl_users_lastname
        ,u.tbl_users_insertdate
        ...
        ->from('tbl_login_history as lh') 
        ->join('tbl_users as u', 'lh.tbl_login_history_user_id = u.tbl_users_role_id', 'LEFT')
        ->join('tbl_application_assignment as tas','tas.smme_id = u.tbl_users_id', 'LEFT')
        ->join('tbl_roles as r', 'u.tbl_users_role_id = r.tbl_roles_id', 'LEFT');
        if($uid){
                $query->where('tas.incubator_id', $uid);
        } 
        if(!empty($fromdate) && !empty($todate)){
            $query->where("DATE_FORMAT(lh.tbl_login_history_insertdate,'%Y-%m-%d') >=  '$fromdate'");
            $query->where("DATE_FORMAT(lh.tbl_login_history_insertdate,'%Y-%m-%d') <=  '$todate'");
        }
    }



    public function getactivityLogReport($roleid='',$fromdate='',$todate=''){ 
        $query = $this->db->select(
        'u.tbl_users_user_uniqueid
        ,u.tbl_users_firstname,u.tbl_users_lastname
        ,u.tbl_users_insertdate
    ...
    public function count_filtered($roleid=[],$fromdate='',$todate='',$method=''){
        $this->$method($roleid,$fromdate,$todate);
        $query = $this->db->get();
        return $query->num_rows();
    }

    public function count_all($roleid=[],$fromdate='',$todate='',$method='') {
        $this->$method($roleid,$fromdate,$todate);
        return $this->db->count_all_results();
    }

    public function get_registrationsDatatables($roleid=[],$fromdate='',$todate='',$method='') {
        $this->$method($roleid,$fromdate,$todate);
        if($_POST['length'] != -1)
    ...
    public function get_DemographicsReportsDatatables($roleid=[],$fromdate='',$todate='',$method='') {
        $this->$method($roleid,$fromdate,$todate);
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get();
    ...
    public function get_incubationStatusReportDatatables($roleid=[],$fromdate='',$todate='',$method='') {
        $this->$method($roleid,$fromdate,$todate);
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get();
    ...
    public function get_channelsReportDatatables($roleid=[],$fromdate='',$todate='',$method='') {
        $this->$method($roleid,$fromdate,$todate);
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get();
     ...
     public function get_securityReportDatatables($roleid=[],$fromdate='',$todate='',$method='') {
        $this->$method($roleid,$fromdate,$todate);
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get();
    ...
    public function get_evaluationReportDatatables($roleid=[],$fromdate='',$todate='',$method='') {
        $this->$method($roleid,$fromdate,$todate);
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get();
    ...
    public function get_activityLogReportDatatables($roleid=[],$fromdate='',$todate='',$method='') {
        $this->$method($roleid,$fromdate,$todate);
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get();
