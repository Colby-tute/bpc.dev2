...
class Analytics_model extends CI_Model
{
    ...
    public function get_smme_by_incubation_application_status($roleId =[],$statusId =[]) {
        ...
        //$this->db->join('tbl_stages', 'tbl_users.tbl_users_role_id = 4 AND tbl_stages.id = tbl_users.tbl_users_status');
...
public function getDemographicsReports($roleId =[],$statusId =[]){
   ...
   $query = $this->db->select(
    ...
    public function getIncubationStatusReport_old($roleId =[],$statusId =[]){
       $result= [];
       $query = $this->db->select(
        'distinct(u.tbl_users_user_uniqueid)
        ,u.tbl_users_firstname,u.tbl_users_lastname
    ...
    public function getChannelsReport_old($roleId =[],$statusId =[]){
           $result= [];
           $query = $this->db->select(
            'distinct(u.tbl_users_user_uniqueid)
            ,u.tbl_users_firstname,u.tbl_users_lastname
