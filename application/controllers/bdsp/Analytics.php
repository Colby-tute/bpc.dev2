...
class Analytics extends MY_Controller
{
	...
	function __construct() {
		...
		$this->load->database();
		$this->load->model("bdsp/Analytics_model");
	}
	...
	public function registrationsReport()
	{
		...
		*/
		...
		$data['page_title'] = 'BDSP Registrations Report';
        $data['header'] = $this->load->view('bdsp/includes/header', $data, TRUE);
		...
		$this->load->view('bdsp/analytics/registration',$data);
	}
	...
	public function incubationStatusReport() {
        ...
        $data['page_title'] = 'BDSP Incubation Status Report';
        $data['header'] = $this->load->view('bdsp/includes/header', $data, TRUE);
        $data['footer'] = $this->load->view('bdsp/includes/footer', NULL, TRUE);
		...
		$this->load->view('bdsp/analytics/incubationstatus',$data);
	}
	...
	public function demographicsReport() {
        ...
        $data['page_title'] = 'BDSP Demographics Report';
        $data['header'] = $this->load->view('bdsp/includes/header', $data, TRUE);
        $data['footer'] = $this->load->view('bdsp/includes/footer', NULL, TRUE);
		
		//$getDemographicsReports=$this->Analytics_model->getDemographicsReports($roleId ,$statusId );
        //$data['reportTabledata'] = json_encode($getDemographicsReports);
		
		$this->load->view('bdsp/analytics/demographics',$data);
	}
	...
	public function evaluationReport() {
		...
		$this->load->view('bdsp/analytics/evaluation',$data);
	}
	...
	public function investmentReport() {
		...
		$this->load->view('bdsp/analytics/investment',$data);
	}
	...
	public function incubationProgressReport() {
		...
		$this->load->view('bdsp/analytics/incubationprogress',$data);
	}
	...
	public function channelsReport()
	{
		...
		$this->load->view('bdsp/analytics/channels',$data);
	}
	...
	public function securityReport() {
		...
		$this->load->view('bdsp/analytics/security',$data);
	}
	...
	public function registrationsReportAjaxData(){
		...
		$registerUser=$this->Analytics_model->get_registrationsDatatables($uid,$fromdate,$todate,$method);	 
       ...
       foreach ($registerUser as $user) { 
		...
		$output = array(
						"draw" => $_POST['draw'],
						"recordsTotal" => $this->Analytics_model->count_all($uid,$fromdate,$todate,$method),
						"recordsFiltered" => $this->Analytics_model->count_filtered($uid,$fromdate,$todate,$method),
						"data" => $data,
				);
	...
	public function demographicsReportsAjaxData(){
		...
		$registerUser=$this->Analytics_model->get_DemographicsReportsDatatables($uid,$fromdate,$todate,$method);	 
	...
	public function incubationStatusReportAjaxData(){
		...
		$registerUser=$this->Analytics_model->get_incubationStatusReportDatatables($uid,$fromdate,$todate,$method);	 
	...
	public function channelsReportAjaxData(){
		...
		$registerUser=$this->Analytics_model->get_channelsReportDatatables($uid,$fromdate,$todate,$method);	 
	...
	public function securityReportAjaxData(){
		...
		$registerUser=$this->Analytics_model->get_securityReportDatatables($uid,$fromdate,$todate,$method);	 
