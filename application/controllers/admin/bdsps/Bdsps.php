...
class Bdsps extends MY_Controller

{
    ...
    function __construct() {
        ...
        $this->load->model("admin/Bdsps_User_model");
...

    {
        ...
        $result = $this->Bdsps_User_model->select_all_bdsps_data_view();
       ...
       /* $datad['d'] = $result;
        ...
        $this->load->view('admin/bdsps/index',$data);
    ...
    public function update_profile_image($id) {
...

      {
        ...
        $this->Bdsps_User_model->image_insert($images,$id,'tbl_users','tbl_users_id');
     ...
     public function add() {
...

            {
                ...
                $result = $this->Bdsps_User_model->insert_master($user,$personal,$business,$smme_teams);
                ...
                if($result[0] == 1) {
...

                        {
                            ...
                            $this->Bdsps_User_model->image_insert($images,$user_id[1],'tbl_users','tbl_users_id');
...

                        {
                            ...
                            $this->Bdsps_User_model->image_insert($images,$user_id[1],'tbl_personal_details','tbl_personal_details_user_id');
...

                        {
                            ...
                            $this->Bdsps_User_model->image_insert($images,$user_id[1],'tbl_business_details','tbl_business_details_user_id');
        ...
        $result=$query->result();
            ...
            foreach($result as $row){
              ...
              <p>Your unique reference ID is <strong> BDSP-'.$randomid.'</strong>, please mention it in any communication with the incubation and support teams. In order to access your profile, you will need to confirm your registration by clicking on the below link:</p>
            ...
            $this->email->send();
                        ...
                        $this->session->set_flashdata('success', 'BDSP profile has been created successfully!');

                        //redirect($_SERVER['HTTP_REFERER']);

                        redirect('admin/bdsps');
                ...
                elseif($result == 0) {
                    ...
                    $this->session->set_flashdata('danger', 'Data could not be saved!');
            ...
            $industrys = $this->Bdsps_User_model->select_industry();
            $data['industrys'] = $industrys;

            $role = $this->Bdsps_User_model->select_all_role();
            ...
            $this->load->view('admin/bdsps/add',$data);
...

    {
        ...
        $result = $this->Bdsps_User_model->select_all_smme_data_view();
...

    {
        ...
        $result = $this->Bdsps_User_model->select_all_incubators_data_view();
    ...
    public function login_history(){
        ...
        $result = $this->Bdsps_User_model->login_history($id);
    ...
    public function get_sub_industries() {
        ...
        $sub_industries = $this->Bdsps_User_model->sub_industries($ind_id);
    ...
    public function edit($i) {
        ...
        $editdt = $this->Bdsps_User_model->select_user_data($i);

        $personal = $this->Bdsps_User_model->select_user_personal_data($i);

        $business = $this->Bdsps_User_model->select_user_business_data($i);

        $smme_teams = $this->Bdsps_User_model->select_smme_teams_data($i);
       ...
       // print_r($editdt);exit;
        ...
        $this->load->view('admin/bdsps/edit',$data);
	 ...
	 public function viewdetails($id) {
      	...
      	$business = $this->Bdsps_User_model->select_user_business_data2($id);
        $smme_teams = $this->Bdsps_User_model->select_smme_teams_data2($id);
        $business_doc = $this->Bdsps_User_model->select_business_docs2($id);
        $role = $this->Bdsps_User_model->select_all_role2();

        $industrys = $this->Bdsps_User_model->select_industry2();
        $data['industrys'] = $industrys;
		...
		$this->load->view('admin/bdsps/viewdetails', $data);
    ...
    public function status($i) {
       ...
       // print_r($editdt);exit;
        ...
        $this->load->view('admin/bdsps/status',$data);
    }
        ...
        //print_r($_POST);exit();
...

            {
                ...
                $user = array(
						 ...
						 'login_approve'=> $this->input->post('login_approve'),
                ...
                $result = $this->Bdsps_User_model->update_master($user,$personal,$business,$smme_teams,$upd_id,$this->input->post('tbl_personal_details_id'),$this->input->post('tbl_business_details_id'));
                ...
                if($result[0] == 1) {
...

                        {
                            ...
                            $this->Bdsps_User_model->image_insert($images,$upd_id,'tbl_users','tbl_users_id');
...

                        {
                            ...
                            $this->Bdsps_User_model->image_insert($images,$upd_id,'tbl_personal_details','tbl_personal_details_user_id');
...

                        {
                            ...
                            $this->Bdsps_User_model->image_insert($images,$upd_id,'tbl_business_details','tbl_business_details_user_id');
                ...
                elseif($result == 0) {
                    ...
                    $this->session->set_flashdata('danger', 'THere was an error updating data!');
    ...
    public function delete($i) {
            $result = $this->Bdsps_User_model->did_delete_company_row($i);

            if($result == 1) {

                $this->session->set_flashdata('success', 'The BDSP profile has been deleted successfully!');
            ...
            elseif($result == 0) {
                ...
                $this->session->set_flashdata('danger', 'The was an error trying to delete the BDSP profile!');
    ...
    public function get_state_by_zone(){
        ...
        $data = $this->Bdsps_User_model->get_state_by_zone($zone_id)->result();
    ...
    public function get_city_by_state(){
        ...
        $data = $this->Bdsps_User_model->get_city_by_state($state_id)->result();
    ...
    public function get_zip_by_city(){
        ...
        $data = $this->Bdsps_User_model->get_zip_by_city($city_id)->result();
    ...
    public function check_username(){
        ...
        $data = $this->Bdsps_User_model->check_username($username,$id);
    ...
    public function check_email(){
        ...
        $data = $this->Bdsps_User_model->check_email($email,$id);
