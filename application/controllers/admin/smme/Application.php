...
class Application extends MY_Controller
{
	function __construct()
	{
		...
		$this->load->model("admin/Application_Modal");
	...
	public function index()
	{
		...
		$this->load->view('admin/smme/application/index', $data);
	...
	public function editbbm($id)
	{
		...
		$this->load->view('admin/smme/application/editbbm', $data);		
	}
	...
	public function bbm()
	{
		...
		$this->load->view('admin/smme/application/bbm', $data);
	}
	...
	public function add()
	{
		...
		if ($_POST) {
			...
			if ($result == 1) {
				...
				$this->session->set_flashdata("success", "The incubation application has been processed successfully!!!");

				redirect('admin/smme/application');

			} else {

				$this->session->set_flashdata("danger", "There was an error processing this application!!!");
	...
	public function update($id)
	{
		...
		if ($result == 1) {
			...
			$this->session->set_flashdata("success", "The application was updated successfully!!!");
			...
			$this->session->set_flashdata("danger", "There was a problem updating this application!!!");
	...
	public function delete($id)
	{
		...
		if ($result == 1) {
			...
			$this->session->set_flashdata("success", "This application was deleted successfully!!!");
			...
			$this->session->set_flashdata("danger", "There was a problem deleting this application!!!");
	...
	public function update_inc_coaches() {
		...
		// print_r($_POST);exit();
		$this->update_incubator_coaches($app_id, $smme_id, $newCoaches, $newInc);
	}

	public function update_incubator_coaches($app_id, $id, $newCoaches, $newInc) {
		$this->db->select("bdsp_id as id");
			...
			$this->session->set_flashdata("success", "incubator, coaches updated successfully!");
		}
