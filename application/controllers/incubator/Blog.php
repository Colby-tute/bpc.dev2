...

{
...

    {
        ...
        $result = $this->Blog_model->select_all_blog_view($this->session->userdata('admin_uniqueid'));
       ...
       /* $datad['d'] = $result;
        ...
        $this->load->view('incubator/blog/index',$data);
    ...
    public function add() {
            ...
            $this->load->view('incubator/blog/add',$data);
    ...
    public function edit($i) {
        ...
        $this->load->view('incubator/blog/edit',$data);
    ...
    public function logout() {
        ...
        redirect('incubator/masterlogin');
