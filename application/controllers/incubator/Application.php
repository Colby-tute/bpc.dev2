...
class Application extends MY_Controller
{
	...
	public function index()
	{
        ...
        $res = $query->result();
        $data['user_status'] = $query->result()[0]->stage;
        $data['status_id'] = $query->result()[0]->id;
		...
		$this->load->view('incubator/application/index', $data);
	...
	public function editbbm($id)
	{
		...
		$this->load->view('incubator/application/editbbm', $data);		
	}
	...
	public function bbm()
	{
		...
		$this->load->view('incubator/application/bbm', $data);
	}
	...
	public function add()
	{
		...
		if ($_POST) {
			...
			if ($result == 1) {
				...
				redirect('incubator/application');
		...
		$this->load->view('incubator/application/add', $data);
	...
	public function edit($id)
	{
		...
		$this->load->view('incubator/application/edit', $data);
	...
	public function stats_change()
	{
		...
		if ($this->input->post('status') == "Approved") {
	        ...
	        } else if ($inc_users_count == 1 && $result[0]->incubation_id == $incubator_id) {
        		$incdata = array(
                    'user_id' => $smme_id,
	...
	public function view($app_id, $id)
	{
		...
		$this->load->view('incubator/application/view', $data);
	}
