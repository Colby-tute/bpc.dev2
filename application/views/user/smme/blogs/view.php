    ...
    <div class="container">
        <div class="breadcrumb-header justify-content-between">
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('user/smme/SearchBlogs') ?>">Knowledge Center</a></li>
			...
			<div class="my-auto breadcrumb-right">
							<a href="#" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-folder mr-2"></i></span><span class="btn-text">Submit an Article </span></button></a>
                                            ...
                                            <div class="card custom-card card_size">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6">
                                                            <a href="<?= site_url('user/smme/Blogs/view/'.$value->tbl_blog_id) ?>" class="pull-right">Read More</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
