            ...
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        echo form_open_multipart("user/smme/team/update/".$value->tbl_smme_teams_id, 'data-toggle="validator"'); ?>
                        <div class="card-body">
							<div class="row">
							...
							<div class="row">
								<div class="col-md-4 form-group mb-3">
									...
									<input name="tbl_smme_teams_mobile" class="sku form-control" required id="tbl_smme_teams_mobile" type="tel" maxlength="13" minlength="8" pattern="[0-9]{8,13}" title="Phone Number length should be 8 - 13" placeholder="Enter Mobile No."  value="<?= $value->tbl_smme_teams_mobile; ?>">
								</div>
