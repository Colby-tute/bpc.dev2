            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="<?= site_url('user/smme/BusinessDetails') ?>">Business Details </a></li>
			 ...
			 <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('user/smme/team/add') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-plus-square mr-2"></i></span><span class="btn-text">Add Team Member </span></button></a>
                                    ...
                                    <tbody>
                                        ...
                                        <td>
											...
											<div class="dropdown-menu">
												<a href="<?= site_url('user/smme/team/edit/'.$row->tbl_smme_teams_id) ?>" class="dropdown-item"><i class="fa fa-edit"></i> Edit</a>
...
<script>
	$(function () {
		$(".delete-smme").on("click", function (event) {
            ...
            location.href = '<?= site_url('user/smme/team/delete/') ?>' + $(this).data('id')
        })
	});
</script>
