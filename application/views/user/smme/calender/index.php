            ...
            <div class="main-content horizontal-content" style="margin-top: 0!important">
                ...
                <div class="container">
                    ...
                    <div class="breadcrumb-header justify-content-between">
                        <div class="my-auto">
                            <div class="d-flex"><h4 class="content-title mb-0 my-auto">Operations</h4></div>
						...
						<div class="my-auto breadcrumb-right">
							...
							<a href="<?= site_url('user/smme/BroadcastMessage/getMessage') ?>" class=""><button class="btn btn-outline-danger mr-3"><span class="icon-label"><i class="fa fa-bell mr-2"></i> </span><span class="btn-text">Broadcast </span></button></a>
