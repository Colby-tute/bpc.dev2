            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Incubator Manager</li>
                    </ol>
                </nav>
									...
									$business[$i]="";
										...
										<button data-toggle="dropdown"
											...
											<div class="dropdown-menu">
											     ...
											     <a href="<?= site_url('user/smme/Incubator/view/'.$row->tbl_users_id) ?>" class="dropdown-item"><i class="fa fa-eye"></i> View
                                                </a>
												
												<a href="<?= site_url('user/smme/Evaluations') ?>" class="dropdown-item"><i class="fa fa-check-square"></i> Evaluate
                                                </a>
																								
												<!-- <a href="<?= site_url('user/smme/Incubator/evaluateIncubator/'.$row->tbl_users_id) ?>" class="dropdown-item"><i class="fa fa-check-square"></i> Evaluate
                                                </a> -->
