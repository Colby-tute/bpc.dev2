...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2">Coaches & Mentors Evaluation</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= site_url('home') ?>">Dashboard</a></li>
					<li class="breadcrumb-item"><a href="<?= site_url('user/smme/bdsp') ?>">Coaches & Mentors</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><?= $bdsp->tbl_users_firstname?> <?= $bdsp->tbl_users_lastname ?></li>
                </ol>
            </nav>
...
<div class="my-auto breadcrumb-right">
							<a href="<?= site_url('user/smme/bdsp') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-arrow-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="card-body iconfont text-left">
                        <form action="<?= site_url("/user/smme/Bdsp/evaluate/" . $bdsp_id) ?>" method="POST"
                              id="milestone_form">
                            <input type="hidden" name="smme_id" value="<?= $this->session->userdata('id_user') ?>">
                            <input type="hidden" name="bdsp_id" value="<?= $bdsp_id ?>">
                            <div class="row">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div class="box box-example-movie"
                                                 style="">
                                                <div class="box-body">
                                                    <label for="">Was the problem solved</label>
                                                    <select name="prob_solv" id="rating1" class="form-control">
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div class="box box-example-movie"
                                                 style="">
                                                <div class="box-body">
                                                    <label for="">Was the problem solved timely</label>
                                                    <select name="prob_solve_timely" id="rating2" class="form-control">
                                                        <option value="1">Not at all Satisfied</option>
                                                        <option value="2">Partly Satisfied</option>
                                                        <option value="3">Satisfied</option>
                                                        <option value="4">More than Satisfied</option>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div class="box box-example-movie"
                                                 style="">
                                                <div class="box-body">
                                                    <label for="">Was the advice that was received "value for money"</label>
                                                    <select name="advice" id="rating3" class="form-control">
                                                        <option value="1">Not at all Satisfied</option>
                                                        <option value="2">Partly Satisfied</option>
                                                        <option value="3">Satisfied</option>
                                                        <option value="4">More than Satisfied</option>
                                    ...
                                    <div class="card custom-card">
                                        <div class="card-body">
                                            <div class="box box-example-movie"
                                                 style="">
                                                <div class="box-body">
                                                    <label for="">Would you recommend this BDSP, mentor or coach</label>
                                                    <select name="recommend" id="rating4" class="form-control">
                                                        <option value="1">Not at all Satisfied</option>
                                                        <option value="2">Partly Satisfied</option>
                                                        <option value="3">Satisfied</option>
                                                        <option value="4">More than Satisfied</option>
