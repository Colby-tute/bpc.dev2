                ...
                <div class="main-signin-wrapper">
                    ...
                    <div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white" >
                        <div class="my-auto authentication-pages">
                            <div>
                                <a href="<?php echo base_url('Registration/thankyou');?>"><img src="<?php echo base_url()."/"; ?>assets/img/brand/logo-white.png" class="main-logo-pages m-0 mb-4" alt="logo"></a>
                    ...
                    <div class="p-5 wd-md-50p">
                        <div class="main-signin-header">
                            ...
                            <?php } ?>
                            <?php echo form_open_multipart("Registration/resend_mail", 'class="login" data-toggle="validator"'); ?>
                                <p>Please check your registered email to confirm. If you didn't received it; please click the below button to resend.</p>
                                <button class="btn btn-main-primary btn-block">Resend</button>
                            <?php echo form_close(); ?>
                        </div>
                        <div class="main-signin-footer mt-3 mg-t-5">
                           <!--  <p><a href="<?php echo base_url('ForgotPassword');?>">Forgot password?</a></p> -->
