...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Incuflex :: Business Plan Competition </title>
                    ...
                    <div class="wd-md-50p login d-none d-md-block page-signin-style p-5 text-white" >
                        <div class="my-auto authentication-pages">
                            <div>
                               ...
                               <p class="mb-5" style="text-align: justify;text-justify: distribute;text-align-last: left;">Participating in a business plan competition can be a rewarding experience. It helps you focus on how you want to run and grow your business, and it can provide much-needed capital and mentoring if you win. </p>
                                <a href="tel:+26622216100" class="btn btn-pink">HelpDesk | +27 74 334 4444</a>
                            </div>
                        </div>
                    </div>
                    <div class="p-5 wd-md-50p">
                        <div class="main-signin-header">
                            <!-- <h2>Incuflex for Competitions</h2> -->
                            <h4>Access and manage your Incuflex for Competition account.</h4>
                            ...
                            <?php } ?>
                            <?php echo form_open_multipart("Login/validate_user", 'class="login" data-toggle="validator"'); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div> 
                                    		<input class="form-control" placeholder="********" type="password" name="password" id="password" required="" data-toggle="password">
                                    	<span toggle="#password" class="fa fa-fw fa-eye field-icon toggle-password" float="right" style="color:#a5a0b1; padding-right:20px;"></span>
                                	</div>
                        ...
                        <div class="main-signin-footer mt-3 mg-t-5">
                            <p>
                                ...
                                <a href="<?php echo base_url('Registration');?>" style="float: right;">Create Account</a> 
                            </p>
                        </div>
                    </div>
                </div>
