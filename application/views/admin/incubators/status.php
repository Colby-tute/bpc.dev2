                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= site_url('admin/incubators/Incubators/status') ?>">Incubator Managers</a></li>
                                ...
                                <div class="card">
                                    <div class="card-body iconfont text-left">
                                        ...
                                        <?php } ?>
                                         ...
                                         <?php echo form_open_multipart("admin/incubators/Incubators/update_status/".$user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
                                         <div id="companyform">
                                            <div class="col-md-12"> 
                                                    <div class="row">
