                                ...
                                <div class="card-body">
                                    <div class="pl-0">
                                        <div class="main-profile-overview">
                                            <div class="main-img-user profile-user"><img alt="" src="<?php echo base_url(); ?>assets/img/faces/6.jpg"><a href="JavaScript:void(0);" class="fas fa-camera profile-edit"></a></div>
                                    ...
                                    <form class="form-horizontal">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="row">
                                                                ...
                                                                <div class="col-md-10">
                                                                    <input type="text" name="tbl_users_mobile" class="form-control" id="tbl_users_mobile"  pattern="[0-9]{10}" title="Phone Number length should be 10" placeholder="Enter your Mobile Number" />
                                                                </div>
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="tbl_personal_details_optional_telephone" class="form-control" id="tbl_personal_details_optional_telephone" pattern="[0-9]{10}" title="Phone Number length should be 10" placeholder="Enter Optopnal Phone Number" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="text" name="tbl_personal_details_district" class="form-control" id="tbl_personal_details_district" placeholder="District" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group ">
                                        ...
                                        <button  class="btn btn-primary waves-effect waves-light next">Next</button>
