...
<div class="container">
	<div class="breadcrumb-header justify-content-between">
		<div>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Incubator Managers</li>
				</ol>
			</nav>
		...
		<div class="my-auto breadcrumb-right">
							<a href="<?= site_url('admin/incubators/Incubators/add') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-user mr-2"></i></span><span class="btn-text">Create INCU Profile </span></button></a>
									...
									<tr>
										...
										<td>
											...
											<div class="dropdown-menu">
											     <a href="<?= site_url('admin/incubators/Incubators/viewdetails/'.$row->tbl_users_id) ?>" class="dropdown-item"> <i class="fa fa-eye"></i> View
                                                </a>
												<a href="<?= site_url('admin/incubators/Incubators/edit/' . $row->tbl_users_id) ?>"
												   class="dropdown-item"><i class="fa fa-edit"></i>
													Edit
												</a>												
												<a href="<?= site_url('admin/incubators/Incubators/status/' . $row->tbl_users_id) ?>"
												...
												<a class="dropdown-item login_view" data-target="#scrollmodal"
												   ...
												   data-id="<?php echo $row->tbl_users_id; ?>"><i class="fa fa-unlock-alt"></i> Activities</a>
											</div>
										</td>
									</tr>
									<?php
