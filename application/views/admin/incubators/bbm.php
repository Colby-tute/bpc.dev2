                                        ...
                                        $i = 1;
                                    		foreach ($view_data as $key => $value) { ?>
                                    			<tr>
													...
													<td><b><?php echo sprintf("%.2f",$bbmpro[$i]);?></b> %</td>
                                    				<!-- <td>
                                                  
                                                        <button onclick="window.location.href='<?= site_url('admin/incubators/Incubators/handlebbm/'.$value->id) ?>'" class="btn btn-primary button_width" style="padding: 3px 6px 0px 6px;" data-toggle="tooltip"><i class="la la-edit iconsetting"></i></button>
			                                        </td> -->
                                    			</tr>
                                    		<?php $i++; }
                                    	?>
