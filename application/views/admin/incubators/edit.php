                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= site_url('admin/incubators') ?>">Incubator Managers</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Update Incubator Details</li>
                                </ol>
                            </nav>
                        </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-body iconfont text-left">
                                        ...
                                        <?php } ?>
                                        <?php echo form_open_multipart("admin/incubators/Incubators/update/".$user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
                                         <div id="companyform">
                                            <div class="col-md-12"> 
                                                    <div class="row">
                                                        ...
                                                        <!-- <div class="col-md-12 form-group mb-3">
                                                                ...
                                                                <select name="tbl_users_role_id" class="form-control js-example-basic-single" id="tbl_users_role_id">
                                                                    ...
                                                                    <?php foreach ($role as $key => $ro){
                                                                        ?>
                                                                        <option value="<?php echo $ro->tbl_roles_id; ?>" <?php if($user->tbl_users_role_id == $ro->tbl_roles_id){echo "selected";}?>><?php echo $ro->tbl_roles_title; ?></option>
                                                      ...
                                                      <tbody id="TextBoxContainer">
                                                       ...
                                                       <tr>
                                                           <td>
                                                            ...
                                                            <td>
                                                              <input  name="tbl_smme_teams_last_name[]" class="sku form-control" id="tbl_smme_teams_last_name" type="text" placeholder="Enter Last Name" value="<?php echo $value->tbl_smme_teams_last_name; ?>">
                                                            </td>
                                                            <td>
        ...
        <script type="text/javascript">
            $('#tbl_business_details_industry').change(function() {
                ...
                else
                {
                    jQuery.ajax({
                        type: "POST",
                        url: "<?=base_url()?>admin/incubators/Incubators/get_sub_industries",
                        dataType: 'text',
                        data: {ind_id:ind_id},
