                    ...
                    <div class="main-card-signin forgot-password d-md-flex wd-100p">
                        <div class="wd-md-50p  page-signin-style p-md-5 p-4 text-white d-none d-md-block ">
                           <div class="my-auto authentication-pages">
                                <div>
                                    ...
                                    <a href="<?php echo base_url('ForgotPassword');?>" class="btn btn-pink">Learn More</a>
                                </div> 
                            </div>
                        </div>
                        <div class="p-5 wd-md-50p">
                            <div class="main-signin-header">
                                ...
                                <?php } ?>
                                 <?php echo admin_form_open("admin/ForgotPassword/send", 'class="login" data-toggle="validator"'); ?>
                                    <div class="form-group">
                                        <label>Email</label> <input class="form-control" placeholder="Enter your email" type="email" id="email" name="email" required="">
                                    </div>
                                    <button class="btn btn-main-primary btn-block">Send</button>
                                <?php echo form_close(); ?>
                            </div>
                            <div class="main-signup-footer mg-t-10">
                                <p>Forget it, <a href="<?php echo base_url('admin/masterlogin');?>"> Send me back</a> to the sign in screen.</p>
                            </div>
                        </div>
                    </div>
                </div>
