                        ...
                        <div class="panel-body tabs-menu-body p-0 border-0">
                            ...
                            <div class="tabs-menu">
                                ...
                                <ul class="nav panel-tabs">
                                    <li class=""><a href="#side1" class="active" data-toggle="tab"><i class="" lass="typcn icon typcn-bell"></i>Total Outstanding Tasks :: <span id="tasks_count"></span></a></li>
                                </ul>
                            </div>
...
<div class="main-footer ht-40">
        ...
        <script type="text/javascript">
            ...
            function loadTasksNotifications() {
                let adminId = <?= $this->session->userdata('id_admin') ?>;
                $.ajax({
                    method: "post",
                    url: '<?= base_url() ?>admin/smme/Smme/processMilestoneTasks/'+adminId,
                    data: {
            ...
            function updateTasksNotification(tasksData) {
                ...
                if(tasks.length) {
                    for(var tasksIdx = 0; tasksIdx < tasks.length; tasksIdx++) {
                        ...
                        tasksList += "<li class='active'>" + 
                                        "<div class='d-flex bd-highlight w-100'>" +
                                            "<div class='user_info'>" +
                                                "<a href='/admin/smme/Smme/createMilestoneTask/"+task['smme_id']+"'>" + 
                    ...
                    $('#tasks_notification_list').empty();
                    $('#tasks_notification_list').append("<li>No outstanding tasks</li>");           
                }
            }
            ...
            function loadQuestionTasksNotifications() {
                $.ajax({
                    method: "post",
                    url: '<?= base_url() ?>admin/smme/Smme/processQuestions/1',
                    data: {
