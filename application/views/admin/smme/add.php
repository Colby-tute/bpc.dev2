                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Create MSME Profile</li>
                                </ol>
                            </nav>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-body iconfont text-left">
                                        ...
                                        <?php } ?>
                                        <?php echo form_open_multipart("admin/smme/Smme/add", 'class="login" data-toggle="validator"'); ?>
                                         <div id="companyform">
                                            <div class="col-md-12"> 
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 form-group mb-3">
                                                            <label for="phone">Optopnal Phone Number</label>
                                                        ...
                                                        <div class="col-md-4 form-group mb-3">
                                                            <label for="phone">How did you hear about the VBI?</label>
                                                                <?php /*$social = array('Referral','Advertisements','Social Media','University','Business Plan Competition','Conference','Exhibition','Other');*/?>
...
/*                                                                    foreach ($social as $key => $value) {*/?>
                                                        ...
                                                        <!--<div class="col-md-4 form-group mb-3">
                                                            ...
                                                            <input type="text" name="tbl_personal_details_district" class="form-control" id="tbl_personal_details_district" placeholder="Enter district" required="" />
                                                        </div>
                                                        <div class="col-md-4 form-group mb-3">
...
/*                                                                    foreach ($industrys as $key => $industry) { */?>
                                                        ...
                                                        <div class="col-md-4 form-group mb-3">
                                                            ...
                                                            <input type="number" name="tbl_business_details_investmant_need" class="form-control" id="tbl_business_details_investmant_need" placeholder="Investment Need" required=""/>
                                                        </div>
                                                        <div class="col-md-4 form-group mb-3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <label class="rdiobox"><input name="tbl_business_details_areyouteam" type="radio" value="1" required=""> <span>Yes</span></label>
                                                                    </div>
                                                                    <div class="col-md-6">
        ...
        <script type="text/javascript">
            $('#tbl_business_details_industry').change(function() {
                ...
                if (ind_id == '') {
                    ...
                    jQuery.ajax({
                        type: "POST",
                        url: "<?=base_url()?>admin/smme/Smme/get_sub_industries/"+ ind_id,
                        dataType: 'text',
                        data: {ind_id:ind_id},
        ...
        <script type="text/javascript">
            $('document').ready(function(){
                ...
                $(function() {                   
                    jQuery.ajax({
                        type: "POST",
                        url: "<?=base_url()?>admin/smme/Smme/get_all_industries",
                        // dataType: 'text',
                        success: function(data) 
                        { //alert(data);
                            //console.log(data);
                            ...
                            var html = ' <option value="">select Industry</option>';
                            $.each(obj,function(index, row){
                                //alert(data.tbl_subcategory_id);
                                html += '<option value="'+row.tbl_industry_id+'">'+row.tbl_industry_name+'</option>';
                              });
                            $('#tbl_business_details_industry').html(html);
                        }
                    });
                return false;
                });
