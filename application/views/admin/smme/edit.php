                        ...
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Update MSME Details</li>
                                </ol>
                            </nav>
                         </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-body iconfont text-left">
                                        ...
                                        <?php } ?>
                                        <?php echo form_open_multipart("admin/smme/Smme/update/".$user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
                                         <div id="companyform">
                                            <div class="col-md-12"> 
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 form-group mb-3"> 
                                                            <label for="firstName1">Mobile Number*</label><br>
                                                             <input class="form-control" id="phone" name="tbl_users_mobile" type="tel" value="<?php if(!empty($userdt)){ echo $user->tbl_users_mobile; } ?>" required="">
                                                                    <input type="hidden" name="tbl_users_contrycode" id="country_code" class="form-control" value="<?php if(!empty($userdt)){ echo $user->tbl_users_contrycode; } ?>">
                                                        </div>
                                                        <!-- <div class="col-md-4 form-group mb-3">
                                                        ...
                                                        <div class="col-md-4 form-group mb-3">
                                                            ...
                                                            <input type="text" name="tbl_personal_details_district" class="form-control" id="tbl_personal_details_district" placeholder="Enter district" value="<?php if(!empty($personal)){ echo $per->tbl_personal_details_district; } ?>" required=""/>
                                                        </div>
                                                        <div class="col-md-4 form-group mb-3">
                    ...
                    jQuery.ajax({
                        ...
                        success: function(data) 
                        {
                            ...
                            $.each(obj, function( index, value ) {
                                // alert(value.tbl_sub_industry_name);
