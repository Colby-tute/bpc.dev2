						...
						<div class="card-body iconfont text-left">
                           <div class="row">
                                <div class="col-sm-3">
                                    ...
                                    <input type="text" id="category_name" name="categoryName" placeholder="Name" class="form-control"/>
                                </div>                    
...
<script type="text/javascript">
	...
	function editCategory() {
        ...
        $.ajax({
            method: "post",
            url: '<?= base_url() ?>admin/FacilityManagement/updateCategory/',
            data: {
    ...
    function createCategory() {
        ...
        if(category_name == "") {
            ...
            $.ajax({
                method: "post",
                url: '<?= base_url() ?>admin/FacilityManagement/createCategory',
	            data: {
    ...
    function deleteCategory(category_id) {
        $.ajax({
            method: "post",
            url: '<?= base_url() ?>admin/FacilityManagement/deleteCategory/'+category_id,
            success:function(data) {
              loadCategories();
            }
        })
	...
	function loadCategories() {
		$.ajax({
			method: "post",
			url: '<?= base_url() ?>admin/FacilityManagement/getCategories',
            success:function(data) {
	...
	function updateCategoriesTable(categoriesData) {
		...
		var viewItemsUrl = '<?= base_url() ?>admin/FacilityManagement/viewCategoryItems/';
		categoriesTable = "";
