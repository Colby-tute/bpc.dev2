                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-body iconfont text-left">
                                        ...
                                        <?php } ?>
                                        <?php echo admin_form_open("admin/role/Role/add", 'class="login" data-toggle="validator"'); ?>
                                            <div class="row">
                                                <div class="col-md-6 form-group mb-3">
                                                    <label for="firstName1">Role Name*</label>
                                                    <input type="text" name="name" class="form-control" id="name" required="" placeholder="Enter Role Title" />
