...
?>
        ...
        <div class="container">
                    ...
                    <!-- row -->
                    <?php echo admin_form_open("admin/user/user/update/".$user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
                                        ...
                                        <div class="main-profile-overview">
                                            ...
                                            <div class="d-flex justify-content-between mg-b-20">
                                                <div>
                                                    ...
                                                    <div class="main-profile-name edit_photo">
                                                        <label for="firstName1">Edit Photo</label>
                                            ...
                                            <div class="d-flex justify-content-between mg-b-20">
                                                <div>
                                                    ...
                                                    <p class="main-profile-name-text"><?php echo $per->tbl_personal_details_occupation;?></p>
                                                </div>
                                            </div>
                                            <h6>Bio</h6>
                                            ...
                                            <div class="main-profile-work-list">
                                                ...
                                                <div class="media">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        <p><?php echo $per->tbl_personal_details_education;?></p> 
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="main-profile-contact-list">
                                        ...
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div>
                                                    <?php echo $per->tbl_personal_details_town_village."<br>".$per->tbl_personal_details_district."<br>".$per->tbl_personal_details_postcode;?>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-pane active show" id="tabCont1">
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <input type="hidden" name="tbl_personal_details_id" value="<?php echo $per->tbl_personal_details_id;?>">
                                                            <input type="hidden" name="tbl_business_details_id" value="<?php echo $buss->tbl_business_details_id;?>">
                                                            <div class="col-md-3">
                                                                <label class="form-label">Occupation</label>
                                                            </div>
                                                            <div class="col-md-9">
                                                                 <input type="text" name="tbl_personal_details_occupation" class="form-control" id="tbl_personal_details_occupation" placeholder="Occupation" value="<?php if(!empty($per)){ echo $per->tbl_personal_details_occupation; } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                            <input type="text" name="tbl_users_firstname" class="form-control" id="tbl_users_firstname" placeholder="First Name" value="<?php if(!empty($user)){ echo $user->tbl_users_firstname; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_users_lastname" class="form-control" id="tbl_users_lastname" placeholder="Last Name" value="<?php if(!empty($user)){ echo $user->tbl_users_lastname; } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                               ...
                                                               <!--  <div class="row">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <input type="text" name="tbl_users_mobile" class="form-control" id="tbl_users_mobile"  maxlength="13" minlength="8" pattern="[0-9]{8,13}" title="Phone Number length should be between 8-13" placeholder="Enter your Mobile Number" value="<?php if(!empty($user)){ echo $user->tbl_users_mobile; } ?>"/>
                                                                    </div>
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                <label class="form-label">Optopnal Phone No.</label>
                                                            </div>
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_personal_details_optional_telephone" class="form-control" id="tbl_personal_details_optional_telephone" maxlength="13" minlength="8" pattern="[0-9]{8,13}" title="Phone Number length should be between 8-13" placeholder="Enter Optopnal Phone Number" value="<?php if(!empty($per)){ echo $per->tbl_personal_details_optional_telephone; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_personal_details_education" class="form-control" id="tbl_personal_details_education" placeholder="Education" value="<?php if(!empty($per)){ echo $per->tbl_personal_details_education; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-3">
                                                                <img alt="" src="<?php echo base_url(); ?>assets/users/<?php echo $per->tbl_personal_details_educational_doc;?>">
                                                                <input type="hidden" name="old_tbl_personal_details_educational_doc" value="<?php echo $per->tbl_personal_details_educational_doc;?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_personal_details_district" class="form-control" id="tbl_personal_details_district" placeholder="District" value="<?php if(!empty($per)){ echo $per->tbl_personal_details_district; } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_personal_details_town_village" class="form-control" id="tbl_personal_details_town_village" placeholder="Town/Village" value="<?php if(!empty($per)){ echo $per->tbl_personal_details_town_village; } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                     <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_personal_details_postcode" class="form-control" id="tbl_personal_details_postcode" placeholder="Post Code" value="<?php if(!empty($per)){ echo $per->tbl_personal_details_postcode; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-pane" id="tabCont2">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                 <input type="text" name="tbl_business_details_name" class="form-control" id="tbl_business_details_name" placeholder="Business Name" value="<?php if(!empty($buss)){ echo $buss->tbl_business_details_name; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                            <input type="text" name="tbl_business_details_industry" class="form-control" id="Industry" value="<?php if(!empty($buss)){ echo $buss->tbl_business_details_industry; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="email" name="tbl_business_details_email" class="form-control" id="tbl_business_details_email"  placeholder="Enter your Email Address" value="<?php if(!empty($buss)){ echo $buss->tbl_business_details_email; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_business_details_phone" class="form-control" id="tbl_business_details_phone" maxlength="13" minlength="8" pattern="[0-9]{8,13}" title="Phone Number length should be between 8-13" placeholder="Enter Optopnal Phone Number" value="<?php if(!empty($buss)){ echo $buss->tbl_business_details_phone; } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_business_details_district" class="form-control" id="tbl_business_details_district" placeholder="Business District" value="<?php if(!empty($buss)){ echo $buss->tbl_business_details_district; } ?>" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_business_details_town_village" class="form-control" id="tbl_business_details_town_village" placeholder="Business Town/Village" value="<?php if(!empty($buss)){ echo $buss->tbl_business_details_town_village; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                    ...
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="Number" name="tbl_business_details_employees" class="form-control" id="tbl_business_details_employees" placeholder="No Of Employees" value="<?php if(!empty($buss)){ echo $buss->tbl_business_details_employees; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-9">
                                                                <input type="text" name="tbl_business_details_investmant_need" class="form-control" id="tbl_business_details_investmant_need" placeholder="Investment Need" value="<?php if(!empty($buss)){ echo $buss->tbl_business_details_investmant_need; } ?>"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            ...
                                                            <?php
                                                            if(!empty($buss) && $buss->tbl_business_details_areyouteam == '1')
                                                            {
                                                            ?>
                                                            <div class="col-md-4">
                                                                  ...
                                                                  <tbody id="TextBoxContainer">
                                                                   ...
                                                                   <tr>
                                                                       <td>
                                                                        ...
                                                                        <td>
                                                                          <input name="tbl_smme_teams_email[]" class="gst form-control form-control-lg" id="tbl_smme_teams_email"  type="email" placeholder="Enter Emailid"  value="<?php echo $value->tbl_smme_teams_email; ?>">
                                                                        </td>
                                                                        <td>
                                                                          <input name="tbl_smme_teams_mobile[]" class="qty form-control form-control-lg" id="tbl_smme_teams_mobile"  type="tel" maxlength="10" placeholder="Enter Mobile No."value="<?php echo $value->tbl_smme_teams_mobile; ?>">
                                                                        </td>                                           
