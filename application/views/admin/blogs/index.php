            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('admin/SearchBlogs') ?>">Knowledge Center</a></li>
                        <?php
                        $count = count($blogs['result']);
                        //echo $count;
                        if ($count > 0) { 
                    ...
                    <div class="card">
                        <div class="card-body iconfont text-left">
                            ...
                            if ($count > 0) {
                                        ...
                                        <div class="card custom-card card_size">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-6">
                                                        <a href="<?= site_url('admin/Blogs/view/'.$value->tbl_blog_id) ?>" class="pull-right">Read More</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <center style="text-align: center !important;"><h3>No knowledge we have at this moment!</h3></center>
                            <?php } ?>
                            </div>
                         </div>
                    </div>
