                        ...
                        <div class="card-body iconfont text-left">
							...
							<div class="row"> 
                                ...
                                foreach ($select_category['category'] as $key => $value) { ?>
                                    <div class="col-xl-12">
                                        <li class="lipadding">
                                            <a href="<?= site_url('admin/Blogs/index/'.$value->tbl_basecenter_category_id.'/0') ?>"><?php echo $value->tbl_basecenter_category_name;?></a>
                                            <ul id="myUL">
                                                ...
                                                <li class="subli" style="margin-bottom: 5px;">
                                                    <a href="<?= site_url('admin/Blogs/index/'.$value->tbl_basecenter_category_id.'/'.$subcat->tbl_basecenter_sub_category_id) ?>"><?php echo $subcat->tbl_basecenter_sub_category_name;?></a>
                                                </li>
                                                <?php } ?>
                                            </ul>
                                        </li>
