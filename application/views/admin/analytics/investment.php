									...
									<?php 
									 ...
									 ?>  
												<tr>
													...
													<td><?php echo ($users['investment_need']>0) ? $users['investment_need']:'0.00' ; ?></td>
													<td><?php echo ($users['revenue_raised'] >0) ? $users['revenue_raised'] :'0.00' ; ?></td>
													<td><?php echo ($users['personal_funds'] > 0) ? $users['personal_funds'] : '0.00' ; ?></td>
													<td><?php echo ($users['funding_gap'] > 0) ? $users['funding_gap'] : '0.00' ; ?></td>
                                                   <td></td>
												</tr>
									<?php 
										}	
