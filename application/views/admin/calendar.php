...
.event-desc p{ margin-bottom:0px;}
   </style>
                <!-- Container opened -->
                <div class="container">
                            ...
                            <div class="col-lg-12 col-xl-4">
                                <div class=" card card--calendar p-0 mg-b-20">
									<?php if ($this->session->flashdata('danger')) { ?>
                                     <div id="infoMessage" class="alert alert-danger"style="margin: 0px;"><?php echo $this->session->flashdata('danger');?></div>
                                     <?php } else if ($this->session->flashdata('success')) { ?>
                                     <div id="infoMessage" class="alert alert-success" style="margin: 0px;"><?php echo $this->session->flashdata('success');?></div>
                                     <?php }
                                     ?>
                                    <?php  //print_r($userdt);
                                    if(!empty($userdt))
                                    { ?>
                                     ...
                                     <?php  echo form_open_multipart("admin/Calendar/Update/".$userdt[0]->tbl_calender_id, 'class="login" data-toggle="validator"'); 
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">  
                                           <div class="form-group" style="margin: 5px 15px;">
                                             ...
                                             <select id="tbl_calender_user_unique_id" name="tbl_calender_user_unique_id" class="form-control">
                                                ...
                                                foreach ($bdsp as $key => $dbs) { ?>
                                                    <option value="<?php echo $dbs->tbl_users_user_uniqueid; ?>"<?php if($dbs->tbl_users_user_uniqueid == $td->tbl_calender_user_unique_id){echo "selected";}?>><?php echo $dbs->tbl_users_firstname.' '.$dbs->tbl_users_lastname;?></option>
                                                <?php } ?>
                                                </optgroup>
                                            </select>
                                            </div>
                                        ...
                                        <div class="col-md-6">  
                                           <div class="form-group" style="margin: 5px 15px;">
                                              <label class="form-label" style="margin: 10px auto;">SMME</label>
                                                <select id="tbl_calender_smme_unique_id" name="tbl_calender_smme_unique_id" class="form-control">
                                                    <option value="">Select</option>
                                                    <?php
                                                    foreach ($smme as $ke => $value) { ?>
                                                        <option value="<?php echo $value->tbl_users_user_uniqueid; ?>"<?php if($value->tbl_users_user_uniqueid == $td->tbl_calender_smme_unique_id){echo "selected";}?>><?php echo $value->tbl_users_firstname.' '.$value->tbl_users_lastname;?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">  
                                               <div class="form-group" style="margin: 5px 15px;">
                                                 ...
                                                 <input class="form-control" name="tbl_calender_start_datetime" id="datetimepicker2" type="text" value="<?php echo $td->tbl_calender_start_datetime;?>" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-6">  
                                               <div class="form-group" style="margin: 5px 15px;">
                                                 ...
                                                 <input type="text" class="form-control" name="tbl_calender_end_datetime" id="datetimepicker" value="<?php echo $td->tbl_calender_end_datetime;?>" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin: 5px 15px;">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="tbl_calender_title" id="tbl_calender_title" value="<?php echo $td->tbl_calender_title?>" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group" style="margin: 5px 15px;">
                                        ...
                                        <div class="form-group" style="margin: 5px 15px;">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea  name="tbl_calender_short_desccription" class="form-control ckeditor" id="tbl_calender_short_desccription" style="display:none;"/><?php echo $td->tbl_calender_short_desccription?></textarea>                                                
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin: 5px 15px;">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" name="tbl_calender_location" id="tbl_calender_location" value="<?php echo $td->tbl_calender_location?>">
                                                </div>
                                                <div class="col-md-6">
                                                <label class="form-label" style="margin: 10px auto;">Event Type</label>
                                                <input type="text" class="form-control" name="tbl_calender_calender_type" id="tbl_calender_calender_type" value="<?php echo $td->tbl_calender_calender_type?>">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            &nbsp;
                                            <a href="<?= site_url('admin/calendar') ?>" class="btn btn-warning waves-effect waves-light">Clear</a>
                                        </div>
									...
									<?php
                                        echo form_open_multipart("admin/Calendar/add", 'class="login" data-toggle="validator"');
                                        ?>
                                        <div class="row">
                                        <div class="col-md-6">  
                                           <div class="form-group" style="margin: 5px 15px;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">  
                                               <div class="form-group" style="margin: 5px 15px;">
                                                 <label class="form-label" style="margin: 10px auto;">Start Date</label>
                                                 <input class="form-control" name="tbl_calender_start_datetime" id="datetimepicker2" type="text" required="">
                                                </div>
                                            </div>
                                            <div class="col-md-6">  
                                               <div class="form-group" style="margin: 5px 15px;">
                                                 <label class="form-label" style="margin: 10px auto;">End Date</label>
                                                    ...
                                                    <input class="form-control" name="tbl_calender_end_datetime" id="datetimepicker" type="text" required="">
                                        ...
                                        <div class="form-group" style="margin: 5px 15px;">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label class="form-label" style="margin: 10px auto;">Event Title</label>
													<input type="text" class="form-control" name="tbl_calender_title" id="tbl_calender_title" required="">
                                                </div>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group" style="margin: 5px 15px;">
                                        ...
                                        <div class="form-group" style="margin: 5px 15px;">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <textarea  name="tbl_calender_short_desccription" class="form-control ckeditor" id="tbl_calender_short_desccription" style="display:none;"/></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group" style="margin: 5px 15px;">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label class="form-label" style="margin: 10px auto;">Event Location</label>
                                                    <input type="text" class="form-control" name="tbl_calender_location" id="tbl_calender_location">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label" style="margin: 10px auto;">Event Type</label>
                                                    <input type="text" class="form-control" name="tbl_calender_calender_type" id="tbl_calender_calender_type">
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="calendar.html" id="mainFormCalendar" method="post" name="mainFormCalendar">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control ckeditor" placeholder="Write some description (optional)" rows="2"></textarea>
                                </div>
        ...
        eventSources: [
                     {
                         events: function(start, end, timezone, callback) {
                             $.ajax({
                             url: '<?php echo base_url() ?>admin/Calendar/get_events',
                             dataType: 'json',
                             data: {
            ...
            $(document).ready(function(){
                ...
                $("#modalCalendarEvent .event-id").on("click", function () {
                  ...
                  var event_id = $(this).val();
                    window.location.replace("<?php echo base_url(); ?>admin/Calendar/edit/"+event_id+"");
                    //alert($('#quillEditor .ql-editor').html());
