        ...
        <div class="container">
                    <div class="breadcrumb-header justify-content-between">
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="<?= site_url('admin/SearchBlogs') ?>">Knowledge Centre</a></li>
                       ...
                       <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('admin/SearchBlogs') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-arrow-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-body iconfont text-left">
                                        ...
                                        <?php } ?>
                                        <?php echo form_open_multipart("admin/Blog/add", 'class="login" data-toggle="validator"'); ?>
                                         <div id="companyform">
                                            <div class="col-md-12"> 
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 form-group mb-3">
                                                            ...
                                                            <select id="tbl_business_details_industry" class="form-control js-example-basic-single" name="tbl_business_details_industry" required="">
                                                                <option value="">Select Category</option>
                                                                    ...
                                                                    foreach ($industrys as $key => $industry) { ?>
                                                                        <option value="<?php echo $industry->tbl_basecenter_category_id;?>"><?php echo $industry->tbl_basecenter_category_name;?></option>
                                                                    <?php }
                                                                    ?>
                                                                </select>
                                                        ...
                                                        <div class="col-md-6 form-group mb-3">
                                                            <label for="tbl_business_details_subindustry">Sub Category</label>
                                                    ...
                                                    <div class="col-md-4 form-group mb-3">
                                                        ...
                                                        <input type="url" name="tbl_blog_video_link" class="form-control" id="tbl_blog_video_link" placeholder="Video Link" />
                                                    </div>
                                                    <div class="col-md-6 form-group mb-3">
                                                        <label for="lastName1">Short Description</label>
                                                        <textarea name="tbl_blog_short_desc" class="form-control ckeditor" id="tbl_blog_short_desc"maxlength="100"></textarea> 
                                                    </div> 
                                                    <div class="col-md-6 form-group mb-3">
                                                        <label for="lastName1">Tags</label>
                                                        <div class="example">
                                                            <div class="form-group">
                                                                <input type="text" data-role="tagsinput" class="form-control adddt" name="tbl_blog_tags">
