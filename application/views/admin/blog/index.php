            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Manage Knowledge Center</li>
                    </ol>
                </nav>
                               ...
                               <!-- <table id="example" class="table text-md-nowrap"> -->
                                   <table class="table text-md-nowrap dataTable no-footer" id="example1" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        ...
                                        <td style="word-break: break-word;"><?php echo $row->tbl_blog_tags;?></td>
                                        ...
                                        <td>
											...
											<a href="<?= site_url('admin/Blogs/view/'.$row->tbl_blog_id) ?>" class="dropdown-item"><i class="fa fa-eye"></i> View
                                                </a>
                                                <a href="<?= site_url('admin/Blog/edit/'.$row->tbl_blog_id) ?>" class="dropdown-item"><i class="fa fa-edit"></i> Edit
                                                </a>
                                                <a href="<?= site_url('admin/Blog/delete/'.$row->tbl_blog_id) ?>" class="dropdown-item"><i class="fa fa-trash"></i> Delete
                                                </a>
                                            </div>      
                                        </td>
                                        </tr>
