...
<div class="container">
	<div class="breadcrumb-header justify-content-between">
		<div>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?= site_url('incubator/Application') ?>">Applications</a></li>
		...
		<a href="<?= site_url('incubator/Application') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-arrow-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
	</div>
...
<script type="text/javascript">
	$(document).ready(function () {
		$('.statuscheck').click(function () {
			...
			jQuery.ajax({
				type: "POST",
				url: "<?=base_url()?>incubator/Application/stats_change",
				dataType: 'text',
				data: {status: status, id: id, user_id: '<?= $user_id ?>'},
				success: function (data) {
								jQuery.ajax({
									type: "POST",
									url: "<?=base_url()?>incubator/Application/update_inc_coaches",
