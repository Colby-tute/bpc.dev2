                                        ...
                                        $i = 1;
                                    		foreach ($view_data as $key => $value) { ?>
                                    			<tr>
													...
													<td><?php echo $value->tbl_application_status;/*user_status;*/?></td>
													
                                    				<td>
			                                            <!-- <a href="<?= site_url('user/Application/edit/'.$value->tbl_application_id) ?>" class="text-success mr-2">
			                                                    <i class="typcn typcn-edit"></i>
			                                            </a>
			                                            <a href="<?= site_url('user/Application/delete/'.$value->tbl_application_id) ?>" class="text-danger mr-2">
			                                                    <i class="typcn typcn-delete"></i>
			                                            </a>       -->
														<?php if ($value->user_status == "Pending Approval" || $value->user_status == "Approved") : ?>
                                                        <button onclick="window.location.href='<?= site_url('incubator/Application/view/'.$value->tbl_application_id.'/'.$value->smme_id) ?>'" class="btn btn-primary button_width" style="padding: 3px 6px 0px 6px;" data-toggle="tooltip" data-original-title="View Application"><i class="la la-eye iconsetting"></i></button>
														<?php endif; ?>
			                                        </td>
                                    			</tr>
                                    		<?php $i++; }
