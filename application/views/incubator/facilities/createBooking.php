...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        <div>
            <h4 class="content-title mb-2">Book Facility</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Asset Booking</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="main-content-app pd-b-0  main-content-calendar pt-0">
            <div class="card">
                <div class="card-body">
                    <!--<form action="<?= site_url("incubator/FacilityManagement/submitCreateBooking") ?>" method="post">-->
                        <form id="createBookingForm" autocomplete="off" action="<?= site_url("incubator/FacilityManagement/submitCreateBooking") ?>" method="post">
                        <div class="row">
...
<script type="text/javascript">
    ...
    function checkItemAvailability() {
        ...
        if(item_id != "" && start_time != "" && end_time != "") {
            ...
            $.ajax({
                method: "post",
                url: '<?= base_url() ?>incubator/FacilityManagement/checkItemAvailability',
                data: {
                    'item_id': item_id,
