...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="main-content-app pd-b-0  main-content-calendar pt-0">
            <div class="card">
                <div class="card-body">
                    <form id="editBookingForm" action="<?= site_url("incubator/FacilityManagement/submitEditBooking") ?>" method="post">
                        <div class="row">
...
<script type="text/javascript">
    ...
    if(selectedCategory) {
        ...
        $.ajax({
            method: "post",
            url: '<?= base_url() ?>incubator/FacilityManagement/getCategoryItems/' + selectedCategory,
