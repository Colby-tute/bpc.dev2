		...
		<div>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" ><a href="<?= site_url('incubator/FacilityManagement/index') ?>">Facility Management</a></li>
					<li class="breadcrumb-item active" aria-current="page">Facility Management</li>
				</ol>
			</nav>
		</div>
		<div class="my-auto breadcrumb-right">
							<a href="<?=site_url('incubator/FacilityManagement/index')?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-bell mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
...
<script type="text/javascript">
	...
	function editCategoryItem() {
        ...
        $.ajax({
            method: "post",
            url: '<?= base_url() ?>incubator/FacilityManagement/updateCategoryItem',
            data: {
                item_id: item_id,
    ...
    function createCategoryItem() {
        ...
        if(item_name == "") {
            ...
            $.ajax({
                method: "post",
                url: '<?= base_url() ?>incubator/FacilityManagement/createCategoryItem',
	            data: {
    ...
    function deleteCategoryItem(item_id) {
        $.ajax({
            method: "post",
            url: '<?= base_url() ?>incubator/FacilityManagement/deleteCategoryItem/'+item_id,
            success:function(data) {
              loadCategoryItems();
            }
        })
    ...
    var category_id = <?= $category_id ?>;
		$.ajax({
			method: "post",
			url: '<?= base_url() ?>incubator/FacilityManagement/getCategoryItems/' + category_id,
            success:function(data) {
	...
	function updateCategoryItemsTable(categoriesData) {
		...
		var viewCategoryItemsUrl = '<?= base_url() ?>incubator/FacilityManagement/viewCategoryItems/';
		categoryItemsTable = "";
