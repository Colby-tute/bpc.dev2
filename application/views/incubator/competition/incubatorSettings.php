...
?>
        ...
        <div class="breadcrumb-header justify-content-between">
			...
			<div class="my-auto breadcrumb-right">
                            <a href="<?= site_url('inc/comp/create')?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-check-square mr-2"></i></span><span class="btn-text">Create Competitions</span></button></a>
