            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('incubator/SearchBlogs') ?>">Knowledge Center</a></li>
                                            ...
                                            <div class="card custom-card card_size">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6">
                                                            <a href="<?= site_url('incubator/Blogs/view/'.$value->tbl_blog_id) ?>" class="pull-right">Read More</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
