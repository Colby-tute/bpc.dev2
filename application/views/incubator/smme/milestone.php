			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
				<div class="card">
					<div class="card-body iconfont text-left">
						<form action="<?= site_url("/incubator/Smme/createMilestone/" . $smmeId) ?>" method="POST"
							  id="milestone_form">
							<div class="row">
								<div class="col-sm-3">
											...
											<?php if ($milestones) {
												foreach ($milestones as $k => $ms) { ?>
													<tr>
														...
														<td>
															<i class="fa fa-edit" onclick="editMilestone('<?= site_url("/incubator/Smme/editMilestone/".$ms['milestone']->id) ?>')" style="cursor: pointer"></i>
															<i class="fa fa-trash" onclick="deleteMilestone('<?= site_url("incubator/Smme/deleteMilestone/".$ms['milestone']->id)."/".$smmeId ?>')" style="margin-left: 5px; cursor: pointer"></i>
														</td>
													</tr>
												<?php }
											} ?>
