                            ...
                            <div class="tab-pane active show" id="tabCont">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mg-t-15">
                                        <button class="btn btn-primary" onclick="createQuestion()" id="create">Add Question</button>
                                    </div>
                                </div>
                                <div class="row">                                        
                                    ...
                                    <div class="col-sm-12">
                                        <div class="table-responsive card-body">
                                            <table id="questions_table" class="table key-buttons text-md-nowrap">
                                                ...
                                                <tr>
                                                    <th scope="col">PID</th>
                                                    <th scope="col">Milestone Questions</th>
...
<script type="text/javascript">
    ...
    function createQuestion() {
        ...
        if(questionText == "" || smmeId == "") {
            ...
            $.ajax({
                method: "post",
                url: '<?= base_url() ?>incubator/Smme/processQuestions/'+smmeId,
                data: {
