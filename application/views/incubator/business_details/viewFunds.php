    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            ...
            <div class="my-auto breadcrumb-right">
							...
							<a href="<?= site_url('incubator/Home/Profile') ?>" class=""><button class="btn btn-outline-danger mr-3"><span class="icon-label"><i class="fa fa-user mr-2"></i> </span><span class="btn-text">Personal Details </span></button></a>
...
<div class="alert alert-success" role="alert">
		...
		<strong>Business Funding!</strong> <br /> Business Incubators or Accelerators grant, loan or help entrepreneurs access funding from different sources.
                                ...
                                <div class="business_details_edit">
                                    <?php echo form_open_multipart("incubator/BusinessDetails/submitEditFunds"); ?>
                                    <div class="form-group">
                                        <div class="row">
