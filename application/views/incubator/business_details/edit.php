    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Business Incubator Details</li>
                </ol>
            </nav>
        ...
        ?>
			...
			<div class="d-flex my-auto breadcrumb-right">
	            <a href="<?= site_url('incubator/team'); ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-users mr-2"></i></span><span class="btn-text">Business Team Members </span></button></a>
				<a href="<?= site_url('incubator/partner'); ?>" class=""><button class="btn btn-outline-danger mr-3"><span class="icon-label"><i class="fa fa-briefcase mr-2"></i> </span><span class="btn-text">Business Partners</span></button></a>
					...
					<div class="border">
						<div class="bg-gray-300 nav-bg">
							<nav class="nav nav-tabs">
								<a class="nav-link active" data-toggle="tab" href="#tabCont1">Business Incubator Details</a>
								<a class="nav-link tabCont2" data-toggle="tab" href="#tabCont2">Business Quick Description</a>
								<a class="nav-link tabCont3" data-toggle="tab" href="#tabCont3">Business Incubator Profile</a>
								<a class="nav-link tabCont4" data-toggle="tab" href="#tabCont4">Business Product & Services</a>
								<a class="nav-link tabCont5" data-toggle="tab" href="#tabCont5">Business Incubator Logo</a>
						...
						<div class="card-body tab-content">
							<div class="tab-pane active show" id="tabCont1">
								...
								<div class="business_details_edit" <?php if (empty($business[0]->tbl_business_details_email)) { echo "style='display:block !important;'"; }?>>
									<?php echo form_open_multipart("incubator/BusinessDetails/update/" . $this->session->userdata('id_user'), 'class="login" data-toggle="validator"'); ?>
							...
							<div class="tab-pane" id="tabCont3">
								<div class="row row-sm">
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
										<?php echo form_open_multipart("incubator/BusinessDetails/insert_business_doc", 'class="login" data-toggle="validator"'); ?>
												...
												<table class="table table-bordered mg-b-0 text-md-nowrap"
													...
													foreach ($business_doc as $key => $value) { ?>
														<tr>
															...
															<td>
																<button style="width:25%" data-toggle="dropdown" class="btn btn-primary btn-block button_width"><i class="la la-cog setting"></i></button>
															<div class="dropdown-menu">
																...
																<a href="<?= site_url('incubator/BusinessDetails/delete/' . $value->tbl_all_documents_id) ?>"
							...
							<div class="tab-pane" id="tabCont4">
                                ...
                                <div class="row row-sm product_services_edit">
                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                        <?php echo form_open_multipart("incubator/BusinessDetails/update_service/". $this->session->userdata("id_user"), 'class="login" data-toggle="validator"'); ?>
...
<script type="text/javascript">
	$('#tbl_business_details_industry').change(function () {
		...
		jQuery.ajax({
			type: "POST",
			url: "<?=base_url()?>incubator/BusinessDetails/get_sub_industries",
			dataType: 'text',
			data: {ind_id: ind_id},
