        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?= site_url('incubator/BusinessDetails/bbm') ?>">Business Building Model</a></li>
         ...
         <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('incubator/BusinessDetails/bbm') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-arrow-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
                    ...
                    <div class="border">
                        ...
                        <div class="card-body tab-content">
                            <div class="tab-pane active show" id="tabCont">
                               <!-- Temporarily disabling the question field --> 
							   <!-- <div class="row">
                                    <div class="col-sm-3">
                                        <label>Question</label>
                                    ...
                                    <div class="col-sm-12 mg-t-15">
                                        <button class="btn btn-primary" onclick="createQuestion()" id="create">Create</button>
                                    </div>
                                </div> -->
                                <div class="row">
                                    <div class="col-sm-11 text-right">
                                        <h3><span class="badge badge-primary" style="color: white" id="questionProgress"></span></h3>
                                    </div>
                                </div>                         
                                <div class="row">
                                    <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <button class="btn btn-primary" onclick="partiallyComplete()" style="margin-left: 15px" id="btnPartiallyComplete">Partially Complete</button>
...
<script type="text/javascript">
    ...
    function createQuestion() {
        ...
        if(questionText == "" || smmeId == "") {
            ...
            $.ajax({
                method: "post",
                url: '<?= base_url() ?>incubator/BusinessDetails/processQuestions/'+smmeId,
                data: {
        ...
        if(questions.length) {
            for(var questionIdx = 0; questionIdx < questions.length; questionIdx++) {
                ...
                questionsTable += "<tr>" + 
                                ...
                                "</td>" +
                                "<td>" + 
                                    "<i class='fa fa-edit'  data-toggle='modal' data-target='#editQuestionModal'  style='margin-left: 15px; cursor: pointer'></i>" +
