...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        ...
        <div class="d-flex my-auto breadcrumb-right">
			<button class="btn btn-outline-danger mr-3"><span class="icon-label"><i class="fa fa-print"></i></span> <span class="btn-text">Print</span></button> <button class="btn btn-success mr-0"><span class="icon-label"><i class="fa fa-download"></i></span> <span class="btn-text">Export</span></button>
		</div>
    </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body iconfont text-left">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <a href="<?= site_url('incubator/BusinessDetails/bbm') ?>" class="btn btn-primary">
                                    Submit
                                </a>
                            </div>
                        </div>
...
<script type="text/javascript">
	function saveAnswer(elem, q_id)
	{
		...
		$.ajax({
			method: "post",
			url: '<?= base_url() ?>incubator/BusinessDetails/saveAnswer',
			data: {
				user_id: '<?= $user_id ?>',
				question: q_id,
				answer: a
