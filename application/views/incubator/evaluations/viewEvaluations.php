...
<div class="container">
	<div class="breadcrumb-header justify-content-between">
		...
		<div class="my-auto breadcrumb-right">
							<a href="<?= site_url('incubator/Evaluations/index') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-check-square mr-2"></i></span><span class="btn-text">Evaluate </span></button></a>
									...
									foreach ($evaluations as $evaluation) {
										?>
											<tr>
												...
												<td>
													<a href="<?= site_url('incubator/Evaluations/viewEvaluation/'.$evaluation->evaluation_id.'/'.$evaluation->evaluatee_id) ?>">
														<i class="fa fa-eye"></i>
													</a>
													<a href="<?= site_url('incubator/Evaluations/deleteEvaluation/'.$evaluation->evaluation_id) ?>">
