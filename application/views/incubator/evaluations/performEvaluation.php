...
<div class="container">
	<div class="breadcrumb-header justify-content-between">
		<div>
			<h4 class="content-title mb-2">Evaluation / <?= $evaluatee_details->tbl_users_firstname.' '.$evaluatee_details->tbl_users_lastname.' ('.$evaluatee_details->tbl_users_user_uniqueid. ')' ?></h4>
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item" aria-current="page">Perform Evaluations</li>
				</ol>
			</nav>
		</div>
