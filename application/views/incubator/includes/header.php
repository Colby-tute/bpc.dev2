...
<head>
	...
	<!-- Title -->
	<title>BEDCO :: Virtual Business Incubator <?php if (!empty($page_title)) { echo $page_title; }  ?> </title>
	...
	<div class="main-header nav nav-item hor-header">
		<div class="container">
			<div class="main-header-left ">
				...
				<a class="header-brand" href="<?= site_url('incubator/home') ?>">
			...
			<div class="main-header-right">
				<div class="nav nav-item  navbar-nav-right ml-auto">
					...
					<div class="nav-item full-screen">
                        <a class="new nav-link full-screen-link" href="<?= site_url('incubator/Broadcast/messageList') ?>">
                            <i class="typcn typcn-bell"></i>
                                <?php if(count_unread_message("incubator_id") > 0){ ?>
                            <span class="badge badge-pill badge-warning float-left"><?php echo count_unread_message("incubator_id");?></span>
                           <?php }else{
                        } ?>
                        </a>
                    </div>
			...
			<div class="horizontal-mainwrapper container clearfix">
				...
				<nav class="horizontalMenu clearfix">
					<ul class="horizontalMenu-list">
						...
						<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="typcn typcn-document-add menu-icon"></i>Competition <i class="fe fe-chevron-down horizontal-icon"></i></a>
                                                    <ul class="sub-menu">
                                                       <li aria-haspopup="true"><a href="<?= site_url('inc/competition') ?>" class="">Manage Competition</a></li> 
                                                    </ul>
						...
						<li aria-haspopup="true"><a href="#" class="sub-icon"><i
										class="typcn typcn-briefcase menu-icon"></i>Users <i
							...
							<li aria-haspopup="true"><a href="<?= site_url('incubator/Operations/indexsmme') ?>" class="">MSME Management</a></li>
                                                                ...
                                                                <li aria-haspopup="true"><a href="<?= site_url('incubator/Application') ?>" class="">Incubation & Status</a></li>
								...
								<li aria-haspopup="true"><a href="<?= site_url('incubator/Operations/incubationstatus') ?>" class="">BBM Progress </a>
								</li>
								<li aria-haspopup="true"><a href="<?= site_url('incubator/Broadcast/index') ?>" class="">Broadcast Messages</a>
								</li>
							</ul>
						</li>
						...
						<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="typcn typcn-point-of-interest menu-icon"></i> Resources  <i class="fe fe-chevron-down horizontal-icon"></i></a>
								...
								<li aria-haspopup="true"><a href="<?= site_url('incubator/Operations/allbdsp') ?>" class="">BDSP, Coaches & Mentors</a></li>
									...
									<li aria-haspopup="true"><a href="<?= site_url('incubator/FacilityManagement/index') ?>" class="">Facility Management</a>
										
									</li>
									<li aria-haspopup="true"><a href="<?= site_url('incubator/Smme/directory') ?>" class="">MSME Directory</a></li>
									<li aria-haspopup="true"><a href="<?= site_url('incubator/Repository/index') ?>" class="">Incubator Repository</a></li>
								</ul>										
						</li>
...
<script type="text/javascript">
   ...
   function search_result() {
    ...
    window.location.href = "<?php echo site_url('incubator/Smme/directory');?>" +"?key="+value;
   }
</script>