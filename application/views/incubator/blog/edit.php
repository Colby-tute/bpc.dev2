...
?>
        ...
        <div class="container">
                    <div class="breadcrumb-header justify-content-between">
                        <div>
                            <h4 class="content-title mb-2">Knowledge Centre</h4>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= site_url('incubator/home') ?>">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="<?= site_url('incubator/blog') ?>">Knowledge Centre</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Update Knowledge Center</li>
                                </ol>
                            </nav>

                        </div>
                        <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('incubator/blog/add') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-check-square mr-2"></i></span><span class="btn-text">Add New Item </span></button></a>
							<a href="<?= site_url('incubator/blog/') ?>" class=""><button class="btn btn-outline-danger mr-3"><span class="icon-label"><i class="fa fa-folder mr-2"></i> </span><span class="btn-text">Manage Knowledge Centre </span></button></a>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div class="card">
                                    <div class="card-body iconfont text-left">
                                        ...
                                        echo form_open_multipart("incubator/Blog/update/".$value->tbl_blog_id, 'class="login" data-toggle="validator"'); ?>
                                         <div id="companyform">
                                            <div class="col-md-12"> 
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 form-group mb-3">
                                                        <label for="lastName1">Vedio Link</label>
                                                        <input type="url" name="tbl_blog_video_link" class="form-control" id="tbl_blog_video_link" placeholder="Vedio Link" value="<?php echo $value->tbl_blog_video_link;?>"/>
                                                    </div>
