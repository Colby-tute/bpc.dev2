                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="<?= site_url('incubator/Blogs/view/'.$row->tbl_blog_id) ?>" class="dropdown-item"><i class="fa fa-eye"></i> View
                                                </a>
                                                <a href="<?= site_url('incubator/Blog/edit/'.$row->tbl_blog_id) ?>" class="dropdown-item"><i class="fa fa-edit"></i> Edit
                                                </a>
                                                <a href="<?= site_url('incubator/Blog/delete/'.$row->tbl_blog_id) ?>" class="dropdown-item"><i class="fa fa-trash"></i> Delete
                                                </a>
                                            </div>      
                                        </td>
                                        </tr>
