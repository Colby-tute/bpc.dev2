...
?>
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('incubator/team') ?>">Business Team Members</a></li>
             ...
             <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('incubator/team') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-chevron-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
        ...
        <div class="">
            ...
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card">
                        <?php echo form_open_multipart("incubator/team/create", 'data-toggle="validator"'); ?>
                        <div class="card-body">
							<div class="row">
								<div class="col-md-4 form-group mb-3">
									...
									<?php foreach($bussiness_detail as $row){ ?>
									<input name="tbl_smme_teams_bussiness_id" class="sku form-control" required id="tbl_smme_teams_bussiness_id" type="hidden"  placeholder="" value="<?= $row->tbl_business_details_id; ?>">
									<?php } ?>
							...
							<div class="row">
								<div class="col-md-4 form-group mb-3">
									...
									<input name="tbl_smme_teams_mobile" class="sku form-control" required id="tbl_smme_teams_mobile" type="tel" maxlength="13" minlength="8" pattern="[0-9]{8,13}" title="Phone Number length should be between 8-13" placeholder="Enter Mobile No." maxlength="10" value="">
								</div>
