...
?>
        ...
        <div class="">
            ...
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card">
                        <?php echo form_open_multipart("incubator/partner/create", 'data-toggle="validator"'); ?>
                        <div class="card-body">
							<div class="row">
								<div class="col-md-4 form-group mb-3">
									<label class="form-label">Company Name</label>
									<input name="name" class="sku form-control" required id="name" type="text"  placeholder="Enter Company Name" value="">
								...
								<div class="col-md-4 form-group mb-3">
									...
									<input name="phone" class="sku form-control" required id="phone" type="tel" maxlength="13" minlength="8" pattern="[0-9]{8,13}" title="Phone Number length should be between 8-13" placeholder="Enter Telephone" value="">
								</div>
							</div>
