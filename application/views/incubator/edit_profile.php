	...
	<div class="row row-sm">
		...
		<div class="col-lg-4">
			<div class="card mg-b-20">
				<div class="card-body">
					<?php echo form_open_multipart("incubator/Profile/update_profile_image/" . $user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
					<div class="pl-0">
						<div class="main-profile-overview">
							<?php if ($user->tbl_users_photo != '') { ?>
								<div class="main-img-user profile-user"><img alt=""
																			 src="<?php echo base_url(); ?>assets/users/<?php echo $user->tbl_users_photo; ?>"><a
											href="JavaScript:void(0);" class="fas fa-camera profile-edit"></a></div>
								<?php
							} else {
								?>
								...
								<div class="main-img-user profile-user">
									<div class="avatar avatar-xxl bg-secondary rounded-circle"
							...
							<div class="d-flex justify-content-between mg-b-20">
								<div>
									<div class="form-group edit_photo">
										<div class="row">
											<div class="col-md-9">
												<input type="file" name="tbl_users_photo" class="custom-file-input"
													   id="tbl_users_photo">
												<label class="custom-file-label" id="tbl_users_photo_label" for="inputGroupFile02"
													   aria-describedby="inputGroupFileAddon02">Choose file</label>
												<input type="hidden" name="old_tbl_users_photo"
													   value="<?php echo $user->tbl_users_photo; ?>">
											</div>
											<div class="col-md-3">
							...
							<div class="d-flex justify-content-between mg-b-20">
								<div>
									...
									<p class="main-profile-name-text"><?php if (!empty($personal)) {
							...
							<div class="main-profile-social-list">
								...
								<label class="main-content-label tx-13 mg-b-20"><?php echo $this->session->userdata('user_type_name'); ?>
									USERID</label>
					...
					<div class="border">
						...
						<div class="card-body tab-content">
							<div class="tab-pane active show" id="tabCont1">
								<?php echo form_open_multipart("incubator/Profile/update/" . $user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
								<div class="form-group ">
									<div class="row">
										<input type="hidden" name="tbl_users_id"
											   value="<?php echo $user->tbl_users_id; ?>">
										<input type="hidden" name="tbl_personal_details_id"
											   value="<?php if (!empty($personal)) {
												   echo $per->tbl_personal_details_id;
											   } ?>">
										<input type="hidden" name="tbl_business_details_id"
											   value="<?php if (!empty($business)) {
												   echo $buss->tbl_business_details_id;
											   } ?>">
										<div class="col-md-3">
											<label class="form-label">Occupation</label>
										</div>
										<div class="col-md-9">
											<input type="text" name="tbl_personal_details_occupation"
												   class="form-control" id="tbl_personal_details_occupation"
												   placeholder="Occupation" value="<?php if (!empty($personal)) {
												echo $per->tbl_personal_details_occupation;
											} ?>" required/>
										</div>
									</div>
								...
								<div class="form-group ">
									<div class="row">
										...
										<div class="col-md-9">
											<input type="text" name="tbl_users_firstname" class="form-control"
												   id="tbl_users_firstname" placeholder="First Name"
												   value="<?php if (!empty($userdt)) {
								...
								<div class="form-group ">
									<div class="row">
										...
										<div class="col-md-9">
											<input type="text" name="tbl_users_lastname" class="form-control"
												   id="tbl_users_lastname" placeholder="Last Name"
												   value="<?php if (!empty($userdt)) {
								...
								<div class="form-group ">
									<div class="row">
										...
										<div class="col-md-9">
											<input class="form-control" id="phone" name="tbl_users_mobile" type="tel"
												   value="<?php if (!empty($userdt)) {
													   echo $user->tbl_users_mobile;
												   } ?>">
											<input type="hidden" name="country_code" id="country_code"
												   class="form-control" value="<?php if (!empty($userdt)) {
												echo $user->tbl_users_contrycode;
											} ?>">
										</div>
									</div>
								</div>
									...
									<div class="row">
										...
										<div class="col-md-9">
											<input type="text" name="tbl_personal_details_optional_telephone"
												   class="form-control" id="tbl_personal_details_optional_telephone"
								...
								<div class="form-group ">
									<div class="row">
										...
										if (!empty($user) && $user->tbl_users_gender == 'M') {
											?>
											<div class="col-md-3">
												<label class="rdiobox"><input name="tbl_users_gender" type="radio"
																			  value="M" checked="">
											...
											<div class="col-md-3">
												<label class="rdiobox"><input name="tbl_users_gender" type="radio"
																			  value="F"> <span>Female</span></label>
											</div>
											<div class="col-md-3">
												<label class="rdiobox"><input name="tbl_users_gender" type="radio"
																			  value="O"> <span>Other</span></label>
											</div>
											<?php
											...
											<div class="col-md-3">
												<label class="rdiobox"><input name="tbl_users_gender" type="radio"
																			  value="M"> <span>Male</span></label>

											</div>
											<div class="col-md-3">
												<label class="rdiobox"><input name="tbl_users_gender" type="radio"
																			  value="F" checked=""> <span>Female</span></label>
											</div>
											<div class="col-md-3">
												<label class="rdiobox"><input name="tbl_users_gender" type="radio"
																			  value="O"> <span>Other</span></label>
								...
								<div class="form-group ">
									<div class="row">
										...
										<div class="col-md-9">
											...
											//print_r($social);
											?>
											<select name="tbl_personal_details_howdidyouknow" class="form-control"
													id="tbl_personal_details_howdidyouknow">
												<?php
												foreach ($social as $key => $value) {
													if (!empty($personal)) { ?>
														<option value="<?php echo $value; ?>"<?php if ($value == $per->tbl_personal_details_howdidyouknow) {
															echo "selected";
								...
								<div class="form-group ">
									<div class="row">
										...
										<div class="col-md-9">
											<input type="text" name="tbl_personal_details_education"
												   class="form-control" id="tbl_personal_details_education"
												   placeholder="Education" value="<?php if (!empty($personal)) {
												echo $per->tbl_personal_details_education;
											} ?>" required/>
										</div>
									</div>
								...
								<div class="form-group">
									<div class="row">
										...
										<div class="col-md-9">
											<input type="date" name="tbl_personal_details_dob" class="form-control"
												   id="tbl_personal_details_dob" value="<?php if (!empty($personal)) {
								...
								<div class="form-group ">
									<div class="row">
										...
										<div class="col-md-9">
											<input type="text" name="tbl_personal_details_district" class="form-control"
												   id="tbl_personal_details_district" placeholder="District"
												   value="<?php if (!empty($personal)) {
								...
								<div class="form-group ">
									<div class="row">
										...
										<div class="col-md-9">
											<input type="text" name="tbl_personal_details_town_village"
												   class="form-control" id="tbl_personal_details_town_village"
												   placeholder="Town/Village" value="<?php if (!empty($personal)) {
								...
								<div class="form-group ">
									<div class="row">
										...
										<div class="col-md-9">
											<input type="text" name="tbl_personal_details_postcode" class="form-control"
												   id="tbl_personal_details_postcode" placeholder="Post Code"
												   value="<?php if (!empty($personal)) {
								...
								<button type="submit" class="btn btn-primary waves-effect waves-light sub1">Update
									Profile
								</button>
								<?php echo form_close(); ?>
							</div>
							<div class="tab-pane" id="tabCont2">
								<div class="row row-sm">
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
										<?php echo form_open_multipart("incubator/Profile/identity_doc/" . $user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>

										<div class="card-body iconfont text-left">
											<div class="form-group">
												<div class="row">
													<div class="col-md-3">
														<input type="text" name="identity_doc_title"
															   id="identity_doc_title" class="form-control"
															   placeholder="Enter Title" required>
													</div>
													<div class="col-md-6">
														<input type="file" name="identity_doc_files"
															   id="identity_doc_files" class="form-control">
													</div>
													<div class="col-md-3">
											...
											<div class="table-responsive">
												<table class="table table-bordered mg-b-0 text-md-nowrap"
													...
													<tr>
														<th scope="col">PID</th>
														<th scope="col" class="table_title_width">Document Name</th>
													...
													foreach ($identity_doc as $key => $value) { ?>
														<tr>
															...
															<div class="dropdown-menu">
																<a href="<?php echo base_url(); ?>assets/users/identity_document/<?php echo $value->tbl_all_documents_document; ?>"
																   target="_blank"
																   class="btn btn-success btn-block btn_width"><i
																			class="far fa-eye"></i></a>

																<a href="<?= site_url('incubator/Profile/delete_indentity_doc/' . $value->tbl_all_documents_id) ?>"
																   class="btn btn-danger btn-block btn_width"><i
																			class="far fa-times-circle"></i></a>
																<!-- <a href="<?= site_url('incubator/Profile/delete_indentity_doc/' . $value->tbl_all_documents_id) ?>" class="text-danger mr-2"><i class="typcn typcn-delete large_icon_custom"></i></a> -->
															</div>
															</td>
														</tr>
														<?php $i++;
							...
							<div class="tab-pane" id="tabCont3">
								<div class="row row-sm">
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
										<?php echo form_open_multipart("incubator/Profile/education_doc/" . $user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
										...
										<div class="card-body iconfont text-left">
											<div class="form-group">
												<div class="row">
													<div class="col-md-3">
														<input type="text" name="education_doc_title"
															   id="education_doc_title" class="form-control"
															   placeholder="Enter Title" required>
													</div>
													<div class="col-md-6">
														<input type="file" name="education_doc_files"
															   id="education_doc_files" class="form-control">
													</div>
													<div class="col-md-3">
														<button class="btn btn-primary" type="submit" id="add_mul_doc">
															Upload
												...
												<table class="table table-bordered mg-b-0 text-md-nowrap"
													...
													foreach ($education_doc as $key => $value) { ?>
														<tr>
															...
															<button data-toggle="dropdown" class="btn btn-primary btn-block button_width"><i class="la la-cog setting"></i></button>
															<div class="dropdown-menu">
																<a href="<?php echo base_url(); ?>assets/users/education_document/<?php echo $value->tbl_all_documents_document; ?>"
																   target="_blank"
																   class="btn btn-success btn-block btn_width"><i
																			class="far fa-eye"></i></a>

																<a href="<?= site_url('incubator/Profile/delete_education_doc/' . $value->tbl_all_documents_id) ?>"
																   class="btn btn-danger btn-block btn_width"><i
																			class="far fa-times-circle"></i></a>

																<!-- <a href="<?= site_url('incubator/Profile/delete_education_doc/' . $value->tbl_all_documents_id) ?>" class="text-danger mr-2"><i class="typcn typcn-delete large_icon_custom"></i></a> -->
															</div>
															</td>
														</tr>
														<?php $i++;
