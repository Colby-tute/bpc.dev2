...
<div class="container">
	<div class="breadcrumb-header justify-content-between">
		...
		<div class="my-auto breadcrumb-right">
							<a href="<?= site_url('bdsp/Evaluations/viewEvaluations') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-chevron-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
									...
									foreach ($applications as $application) {
										?>
											<tr>
												...
												<td>
													<a href="<?= site_url('bdsp/Evaluations/evaluateesList/'.$application->app_id) ?>"><i class="fa fa-edit"></i></a>
												</td>
											</tr>
								<?php
									}
