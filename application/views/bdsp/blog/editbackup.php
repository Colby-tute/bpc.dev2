                   ...
                   <div class="breadcrumb-header justify-content-between">
                        <div>
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="<?= site_url('bdsp/home') ?>">Home</a></li>
                                    <li class="breadcrumb-item"><a href="<?= site_url('bdsp/smme') ?>">SMME</a></li>
                    ...
                    <div class="row row-sm">
                        ...
                        <div class="col-lg-4">
                            <div class="card mg-b-20">
                                <div class="card-body">
                                    <?php echo form_open_multipart("bdsp/smme/Smme/update_profile_image/".$user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
                                    <div class="pl-0">
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                    <?php echo form_open_multipart("bdsp/smme/Smme/update/".$user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
                                    <div class="border">
