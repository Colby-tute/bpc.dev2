			...
			<div class="col-lg-12 col-xl-4">
				<div class=" card card--calendar p-0 mg-b-20">
					...
					if (!empty($userdt)) { ?>
						...
						<?php echo form_open_multipart("bdsp/Calendar/Update/" . $userdt[0]->tbl_calender_id, 'class="login" data-toggle="validator"');
						...
						<?php
						echo form_open_multipart("bdsp/Calendar/add", 'class="login" data-toggle="validator"');
						?>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group" style="margin: 5px 15px;">
			...
			eventSources: [
				{
					events: function (start, end, timezone, callback) {
						$.ajax({
							url: '<?php echo base_url() ?>bdsp/Calendar/get_events',
							dataType: 'json',
							data: {
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#modalCalendarEvent .event-id").on("click", function () {
			...
			window.location.replace("<?php echo base_url(); ?>bdsp/Calendar/edit/" + event_id + "");
			//alert($('#quillEditor .ql-editor').html());
		});
	});
</script>
