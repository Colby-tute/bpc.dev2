        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> <?= $user->tbl_users_firstname ?> <?= $user->tbl_users_lastname ?> / <?= $user->tbl_users_user_uniqueid ?></li>
                </ol>
            </nav>
                                                ...
                                                <table class="table table-striped">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th width="150" scope="col">Edit</th>
                                                    ...
                                                    <tbody>
                                                        <?php foreach ($questions as $k => $question) : ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <i class="fa fa-edit" onclick="window.location.href='<?= site_url('bdsp/BusinessDetails/editquestion/'.$question->id) ?>'" style="cursor: pointer"></i>
                                                                </td>
                                                                <td>
                                                                    <div>
