	...
	<div class="row row-sm">
		...
		<div class="col-lg-4">
			<div class="card mg-b-20">
				<div class="card-body">
					<?php echo form_open_multipart("bdsp/Profile/update_profile_image/" . $user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
					<div class="pl-0">
										...
										<div class="row">
											<div class="col-md-9">
												<input type="file" name="tbl_users_photo" class="custom-file-input"
													   id="tbl_users_photo">
												<label id="tbl_users_photo_label" class="custom-file-label" for="inputGroupFile02"
					...
					<div class="border">
						...
						<div class="card-body tab-content">
							<div class="tab-pane active show" id="tabCont1">
								<?php echo form_open_multipart("bdsp/Profile/update/" . $user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
									...
									<div class="row">
										...
										<div class="col-md-9">
											<input type="text" name="tbl_personal_details_optional_telephone"
												   ...
												   placeholder="Enter Optopnal Phone Number"
												   value="<?php if (!empty($personal)) {
							...
							<div class="tab-pane" id="tabCont2">
								<div class="row row-sm">
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
										<?php echo form_open_multipart("bdsp/Profile/identity_doc/" . $user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
													...
													foreach ($identity_doc as $key => $value) { ?>
														<tr>
															...
															<div class="dropdown-menu">
																...
																<a href="<?= site_url('bdsp/Profile/delete_indentity_doc/' . $value->tbl_all_documents_id) ?>"
																   class="btn btn-danger btn-block btn_width"><i
																			class="far fa-times-circle"></i></a>
																<!-- <a href="<?= site_url('bdsp/Profile/delete_indentity_doc/' . $value->tbl_all_documents_id) ?>" class="text-danger mr-2"><i class="typcn typcn-delete large_icon_custom"></i></a> -->
															</div>
															</td>
														</tr>
														<?php $i++;
							...
							<div class="tab-pane" id="tabCont3">
								<div class="row row-sm">
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
										<?php echo form_open_multipart("bdsp/Profile/education_doc/" . $user->tbl_users_id, 'class="login" data-toggle="validator"'); ?>
													...
													foreach ($education_doc as $key => $value) { ?>
														<tr>
															...
															<div class="dropdown-menu">
																...
																<a href="<?= site_url('bdsp/Profile/delete_education_doc/' . $value->tbl_all_documents_id) ?>"
																   class="btn btn-danger btn-block btn_width"><i
																			class="far fa-times-circle"></i></a>

																<!-- <a href="<?= site_url('bdsp/Profile/delete_education_doc/' . $value->tbl_all_documents_id) ?>" class="text-danger mr-2"><i class="typcn typcn-delete large_icon_custom"></i></a> -->
															</div>
															</td>
														</tr>
														<?php $i++;
