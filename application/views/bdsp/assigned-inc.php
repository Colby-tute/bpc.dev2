										...
										<tr>
											...
											<td>
												...
												<div class="dropdown-menu">
													<?php $name = $row->tbl_users_firstname . " " . $row->tbl_users_lastname ?>
													<a href="<?= site_url('bdsp/operations/viewdetails/'.$row->tbl_users_id) ?>"
													   class="dropdown-item"><i class="fa fa-eye"></i> View
													</a>
													<a href="<?= site_url('bdsp/Evaluations/index') ?>"
													   class="dropdown-item"><i class="fa fa-edit"></i> Evaluate
													</a>
												</div>
											</td>
										</tr>
