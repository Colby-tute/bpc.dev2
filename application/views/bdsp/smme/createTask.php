	...
	<div class="breadcrumb-header justify-content-between">
		<div>
		 ...
		 <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('bdsp/Operations') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-arrow-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
					...
					<div class="card-body iconfont text-left">
						...
						<div class="row" style="margin-top: 20px; margin-left: 15px;">
							<div class="col-xs-4" style="border: 1px solid #efefef; border-radius: 3px; padding: 8px">
								...
								<button class="btn btn-primary" id="addDefault" style="margin-top: 20px">Add "Default"
									Board
								</button>
							</div>
						</div>
...
<script>
	let element_id;
	const path = "http://vbi.bedco.org.ls/itrd"
	$(function () {
		...
		var KanbanTest = new jKanban({
			...
			dropEl: function (el, target, source, sibling) {
				...
				$.ajax({
					method: "POST",
					url: path+"/bdsp/Smme/orderElements",
					data: {
			...
			buttonClick: function (el, boardId) {
				...
				formItem.addEventListener("submit", function (e) {
					...
					$.ajax({
						method: "POST",
						url: path+"/bdsp/Smme/saveElement",
						data: {
							brdID: boardId,
							title: text,
							index: 1,
	...
	function removeElement(elem) {
		...
		$.ajax({
			method: "POST",
			url: path+"/bdsp/Smme/deleteElement",
			data: {
				id: element.text(),
	...
	function updateElement() {
		...
		$.ajax({
			method: "POST",
			url: path+"/bdsp/Smme/updateElement",
			data: {
				id: element.text(),
	...
	function deleteBoard(elem) {
		...
		$.ajax({
			method: "POST",
			url: path+"/bdsp/Smme/deleteBoard",
			data: {
				boardId: id
			}
		})
