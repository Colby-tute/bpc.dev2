...
<div class="container">
	...
	<div class="breadcrumb-header justify-content-between">
		<div>
			<h4 class="content-title mb-2">BBM
				 / <?= $smme->tbl_users_firstname ?> <?= $smme->tbl_users_lastname ?> / MSME - <?= $smme->tbl_users_user_uniqueid ?>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Business Building Model Assessment</li>
				</ol>
			</nav>
		</div>
