...
<div class="container">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="col-sm-12">
                ...
                <input type="text" id="editTargetDate" name="target_date" placeholder="Target date"
                       class="form-control datepicker target_date"/>
            </div>
            <br />
          </div>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?= site_url('bdsp/Operations/index') ?>">Business Building Model</a></li>
      ...
      <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('bdsp/Operations/index') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-arrow-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
                            ...
                            <div class="tab-pane active show" id="tabCont">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" id="target_date" name="targetDate" placeholder="Target date"
                                                                               class="form-control datepicker target_date"/>
                                    </div>                      
                                        ...
                                        <div class="table-responsive card-body">
                                            <table id="questions_table" class="table key-buttons text-md-nowrap">
                                                ...
                                                <tr>
                                                    ...
                                                    <th scope="col">Milestone Target Date</th>
...
<script type="text/javascript">
    ...
    $('#editQuestionModal').on('show.bs.modal', function (e) {
        if (e.namespace === 'bs.modal') {
            ...
            var target_date = question_row.find(".target_date").text();
            $(this).find(".question_id").val(question_id);
            $(this).find(".question_text").val(question_text);
            $(this).find(".target_date").val(target_date);
        }
    });
    ...
    function createQuestion() {
        ...
        if(questionText == "" || smmeId == "") {
            ...
            $.ajax({
                method: "post",
                url: '<?= base_url() ?>bdsp/Smme/processQuestions/'+smmeId,
                data: {
    ...
    function partiallyComplete() {
        ...
        for (var rowIdx = 0; rowIdx < questionsTab.rows.length - 1; rowIdx++) {
            answerStatus = $('#questions_table tbody tr:eq('+rowIdx+')').find('td:eq(4) input').is(':checked')
            if(answerStatus) {
    ...
    function updateQuestionUITable(questionsData) { 
        ...
        if(questions.length) {
            for(var questionIdx = 0; questionIdx < questions.length; questionIdx++) {
                ...
                completionDate = question['completion_date'] ? question['completion_date'] : '';
                questionsTable += "<tr>" + 
                                ...
                                "<td class='target_date'>" + question['target_date'] + "</td>" +
                                "<td class='completion_date'>" + completionDate + "</td>" +
                                "<td align='center'>" + 
