    ...
    <div class="breadcrumb-header justify-content-between">
        <div>
         ...
         <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('bdsp/Operations/incubationstatus') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-arrow-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
                        ...
                        <div class="tab-pane active show"  id="tabCont1">
                            <div class="row">
                                <div class="table-responsive">
                                     <table class="table text-md-nowrap no-footer" id="example" role="grid" aria-describedby="example_info">
                                        <thead>
                                        <tr>
                                            <th scope="col">#</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="dropdown-menu">
                                                            ...
                                                            <a href="<?= site_url('bdsp/BusinessDetails/handlebbm/' . $smmeid) ?>"
                                                               class="dropdown-item"><i class="fa fa-eye"></i> View BBM Assessment
                                                            </a> -->
                                                            <a href="<?= site_url('bdsp/Smme/handleMilestoneQuestions/' . $smmeid) ?>"
