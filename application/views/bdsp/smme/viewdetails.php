		...
		<div>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?= site_url('bdsp/Operations/index') ?>">MSME Management</a></li>
								...
								<div class="form-group ">
										<div class="row">
											<div class="col-md-12">
												...
												<table class="table table-bordered mg-b-0 text-md-nowrap" id="example1" role="grid" aria-describedby="example1_info">
													<thead>
													<tr>
													...
													<!--<?php
													$i=0;
													foreach($incu_doc as $row) { 
													 if($row->tbl_all_documents_document !="" || $row->tbl_all_documents_document != null){
													?> -->
														<tr>
															<td><?php echo $i + 1; ?></td>
															<td>
																<?php echo $row->tbl_all_documents_title; ?>
															</td>
															<td>
															<a class="btn btn-success btn-block btn_width" href="<?php echo base_url(); ?>assets/users/<?php echo $row->tbl_all_documents_document; ?>"
												...
												<table class="table table-bordered mg-b-0 text-md-nowrap" id="example1" role="grid" aria-describedby="example1_info">
													...
													?> -->
														<tr>
															...
															<td>
															<a class="btn btn-success btn-block btn_width" href="<?php echo base_url(); ?>assets/Application/Business_Document/<?php echo $row->tbl_all_documents_document; ?>"
																   target="_blank"><i class="far fa-eye"></i></a>
														    </td>
														</tr>
													<!--<?php } }
