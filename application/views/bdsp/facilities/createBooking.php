...
<div class="container">
    <div class="breadcrumb-header justify-content-between">
        <div>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">Book An Asset</li>
				</ol>
			</nav>
		</div>
        ...
        <div class="main-content-app pd-b-0  main-content-calendar pt-0">
            <div class="card">
                <div class="card-body">
                    <!--<form action="<?= site_url("bdsp/FacilityManagement/submitCreateBooking") ?>" method="post">-->
                        <form id="createBookingForm" autocomplete="off" action="<?= site_url("bdsp/FacilityManagement/submitCreateBooking") ?>" method="post">
                    	<div class="row">
