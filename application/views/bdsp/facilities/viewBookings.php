...
<div class="container">  
	...
	<div class="breadcrumb-header justify-content-between">
		...
		<div class="my-auto breadcrumb-right">
							<a href="<?= site_url('bdsp/FacilityManagement/createBooking') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-check-square mr-2"></i></span><span class="btn-text">Create A Booking </span></button></a>
...
<script type="text/javascript">
    ...
    function deleteBooking(booking_id) {
        $.ajax({
            method: "post",
            url: '<?= base_url() ?>bdsp/FacilityManagement/deleteBooking/'+booking_id,
	...
	function loadBookings() {
		...
		$.ajax({
			method: "post",
			url: '<?= base_url() ?>bdsp/FacilityManagement/getBookings',
	...
	function updateBookingsTable(bookingsData) {
		...
		var editBookingUrl = '<?= base_url() ?>bdsp/FacilityManagement/editBooking/';
		bookingsTable = "";
		if(bookings.length) {
