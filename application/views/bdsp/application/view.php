...
<div class="container">
	<div class="breadcrumb-header justify-content-between">
		<div>
			...
			<nav aria-label="breadcrumb">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?= site_url('bdsp/Application') ?>">Applications</a></li>
		...
		?>
		<a href="<?= site_url('bdsp/Application') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-arrow-circle-left mr-2"></i></span><span class="btn-text">Go Back </span></button></a>
						...
						<div class="border">
							<div class="bg-gray-300 nav-bg">
								<nav class="nav nav-tabs">
									...
									<a class="nav-link" data-toggle="tab" href="#tabCont4">Incubator | BDSP | Coaches | Mentors</a>
...
<div class="col-md-3">
								...
								<div class="tab-pane" id="tabCont3">
									...
									<div class="form-group ">
										<div class="row">
											...
											<div class="col-md-3">
												<label class="form-label label_font">How did you hear about the VBI?</label>
												<b class="b_font"><?php if (!empty($personal)) {
								...
								<div class="tab-pane" id="tabCont4">
									<div class="business_details_show">
										<div class="row">
											<div class="col-sm-6">
												<label class="form-label">Incubator Manager</label>
											...
											<div class="col-sm-6">
												...
												<b class="b_font"><?php if ($bdsps) {
													foreach ($bdsps as $bdsp) {
														echo (in_array($bdsp->id, $selectedBdsps) ? $bdsp->name." ".$bdsp->last_name : "");
													}
												} ?></b>
													
												<select name="coaches[]" multiple id="bdsp-select" class="d-none hide form-control">
													<?php if ($bdsps) {
														foreach ($bdsps as $bdsp) {
											...
											<div class="row ">
												<section class="container col-xs-12">
													<div class="table table-responsive">
														<!--<label class="form-label" style="font-size: 16px;">Staff Members</label> -->
		...
		$('.statuscheck').click(function () {
			...
			jQuery.ajax({
				...
				success: function (data) {
								jQuery.ajax({
									type: "POST",
									url: "<?=base_url()?>bdsp/Application/update_inc_coaches",
