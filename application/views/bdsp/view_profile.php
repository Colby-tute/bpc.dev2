...
<div class="container">
	...
	<div class="breadcrumb-header justify-content-between">
		...
		<div class="my-auto breadcrumb-right">
							...
							<a href="<?= site_url('bdsp/Profile/edit_profile/'.$this->session->userdata('id_user')) ?>" class=""><button class="btn btn-outline-danger mr-3"><span class="icon-label"><i class="fa fa-user mr-2"></i> </span><span class="btn-text">Update Personal Details </span></button></a>
