        ...
        <div class="breadcrumb-header justify-content-between">
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?= site_url('bdsp/home') ?>">Dashboard</a></li>
						 <li class="breadcrumb-item"><a href="<?= site_url('bdsp/BusinessDetails') ?>">Business Details</a></li>
			 ...
			 <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('bdsp/team/add') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-plus-square mr-2"></i></span><span class="btn-text">Add Team Member </span></button></a>
                            ...
                            <div class="table-responsive">
							   ...
							   <table class="table text-md-nowrap dataTable no-footer" id="example1" role="grid" aria-describedby="example1_info">
                                    ...
                                    <tbody>
                                        ...
                                        <td><?php echo $row->tbl_smme_teams_job_title;?><br>
                                            <i><?php echo $row->tbl_smme_teams_qualification;?></i> &nbsp;&nbsp; | &nbsp; <i><?php echo $row->tbl_smme_teams_experience;?> years</i></td>
                                        <td>
											<button data-toggle="dropdown" class="btn btn-primary btn-block button_width"><i class="la la-cog setting"></i></button>
											<div class="dropdown-menu">
												<a href="<?= site_url('bdsp/team/edit/'.$row->tbl_smme_teams_id) ?>" class="dropdown-item"><i class="fa fa-edit"></i> Edit</a>
...
<script>
	$(function () {
		$(".delete-smme").on("click", function (event) {
            ...
            location.href = '<?= site_url('bdsp/team/delete/') ?>' + $(this).data('id')
        })
	});
</script>
