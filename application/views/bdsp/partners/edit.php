            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= site_url('bdsp/partner') ?>">Business Partner</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Partner Details</li>
                    </ol>
                </nav>
            ...
            <div class="row row-sm">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        echo form_open_multipart("bdsp/partner/update/".$value->id, 'data-toggle="validator"'); ?>
                        <div class="card-body">
							<div class="row">
