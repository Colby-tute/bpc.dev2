        ...
        <div class="breadcrumb-header justify-content-between">
            <div>
			 ...
			 <div class="my-auto breadcrumb-right">
							<a href="<?= site_url('bdsp/partner/add') ?>" class=""><button class="btn btn-outline-primary mr-3"><span class="icon-label"><i class="fa fa-plus-square mr-2"></i></span><span class="btn-text">Add New Partner</span></button></a>
                                    ...
                                    <tbody>
                                        ...
                                        <td>
											...
											<div class="dropdown-menu">
												<a href="<?= site_url('bdsp/partner/edit/'.$row->id) ?>" class="dropdown-item"><i class="fa fa-edit"></i> Edit</a>
...
<script>
	$(function () {
		$(".delete-smme").on("click", function (event) {
            ...
            location.href = '<?= site_url('bdsp/partner/delete/') ?>' + $(this).data('id')
        })
	});
</script>
